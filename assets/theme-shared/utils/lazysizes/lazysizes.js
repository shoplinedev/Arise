...
window.SLM['theme-shared/utils/lazysizes/lazysizes.js'] = window.SLM['theme-shared/utils/lazysizes/lazysizes.js'] || function () {
  const _exports = {};
  ...
  function l(window, document, Date) {
    ...
    var loader = function () {
      ...
      var switchLoadingClass = function (e) {
        ...
        lazysizes.extraElements = lazysizes.extraElements.filter(item => {
          return item !== elem;
        });
