...
window.SLM['theme-shared/biz-com/orderTracking/form-item/username.js'] = window.SLM['theme-shared/biz-com/orderTracking/form-item/username.js'] || function () {
  const _exports = {};
  const { t } = window['SLM']['theme-shared/utils/i18n.js'];
  const { countriesCodeMap } = window['SLM']['theme-shared/utils/countries.js'];
  const { CODE_PHONE_PATTERN } = window['SLM']['theme-shared/utils/pattern.js'];
  const { formatPhone, usernameValidator } = window['SLM']['theme-shared/biz-com/orderTracking/utils/index.js'];
  const getCodeSelectTemplate = window['SLM']['theme-shared/biz-com/orderTracking/templates/getCodeSelect.js'].default;
