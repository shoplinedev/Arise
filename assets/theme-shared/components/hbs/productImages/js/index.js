  ...
  class ProductImages {
    ...
    initPhotoSwipe(slidesWrapID, platform) {
      ...
      triggerDom.on('click', eventDom, function () {
        if ($(this).hasClass('swiper-slide-duplicate') || !get(self, 'slideItems.length')) {
          return;
        }
