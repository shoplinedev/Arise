    ...
    (() => {
        ...
        function userHdReport() {
            ...
            if (isSignIn || isSignUp) {
                var _window$HdSdk;
                null === (_window$HdSdk = window.HdSdk) || void 0 === _window$HdSdk ? void 0 : _window$HdSdk.shopTracker.report(60079992, {
                    iframe_id: 1,
                    page: "user_page",
                    event_name: "view"
                });
            ...
            if (isSignIn) {
                var _window$HdSdk2;
                null === (_window$HdSdk2 = window.HdSdk) || void 0 === _window$HdSdk2 ? void 0 : _window$HdSdk2.shopTracker.report(60079992, {
            ...
            if (isSignUp) {
                var _window$HdSdk3;
                null === (_window$HdSdk3 = window.HdSdk) || void 0 === _window$HdSdk3 ? void 0 : _window$HdSdk3.shopTracker.report(60079992, {
                    event_name: "component_view",
                    custom_component: [ "sign_up_tab" ]
                });
            }
            if (isCenter) {
                var _window$HdSdk4, _window$HdSdk5;
                null === (_window$HdSdk4 = window.HdSdk) || void 0 === _window$HdSdk4 ? void 0 : _window$HdSdk4.shopTracker.report(60079999, {
                    iframe_id: 1,
                    page: "consumer_home",
                    event_name: "view"
                });
                null === (_window$HdSdk5 = window.HdSdk) || void 0 === _window$HdSdk5 ? void 0 : _window$HdSdk5.shopTracker.report(60079999, {
                    event_name: "component_view",
            ...
            if (isMessage) {
                var _window$HdSdk6;
                null === (_window$HdSdk6 = window.HdSdk) || void 0 === _window$HdSdk6 ? void 0 : _window$HdSdk6.shopTracker.report(60079999, {
                    event_name: "component_view",
            ...
            if (isOrders) {
                var _window$HdSdk7;
                null === (_window$HdSdk7 = window.HdSdk) || void 0 === _window$HdSdk7 ? void 0 : _window$HdSdk7.shopTracker.report(60079999, {
                    event_name: "component_view",
            ...
            if (isRefunds) {
                var _window$HdSdk8;
                null === (_window$HdSdk8 = window.HdSdk) || void 0 === _window$HdSdk8 ? void 0 : _window$HdSdk8.shopTracker.report(60079999, {
                    event_name: "component_view",
