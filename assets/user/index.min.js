    ...
    var __webpack_modules__ = {
        ...
        "../shared/browser/node_modules/@sentry/browser/esm/sdk.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            function initAndBind(clientClass, options) {
                if (true === options.debug) if ((0, env.isDebugBuild)()) esm_logger.logger.enable(); else console.warn("[Sentry] Cannot initialize SDK with `debug` option using a non-debug bundle.");
            ...
            function startSessionTracking() {
                ...
                if ("undefined" === typeof document) {
                    (0, env.isDebugBuild)() && esm_logger.logger.warn("Session tracking in non-browser environment with @sentry/browser is not supported.");
                    return;
                }
                var hub = (0, esm_hub.getCurrentHub)();
