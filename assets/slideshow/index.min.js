...
(self["webpackChunkArise"] = self["webpackChunkArise"] || []).push([ [ "slideshow" ], {
    ...
    "./src/assets/stage/slideshow/index.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
        ...
        const effect_flickity_fade = {
            ...
            create: function() {
                ...
                (0, utils_utils.bindModuleMethods)(swiper, {
                    flickityFadeEffect: _objectSpread({}, Fade)
                });
            },
            on: {
                beforeInit: function(swiper) {
                    if ("flickity-fade" !== swiper.params.effect) return;
                    swiper.classNames.push("".concat(swiper.params.containerModifierClass, "flickity-fade"));
                    var overwriteParams = {
                        slidesPerView: 1,
                        slidesPerColumn: 1,
                        slidesPerGroup: 1,
                ...
                slideChange: function(swiper) {
                    if ("flickity-fade" !== swiper.params.effect) return;
                    var $animateItems = swiper.slides.eq(this.activeIndex).find(".animation-contents");
                    $animateItems.off("animationend");
                    Promise.all($animateItems.map((function(item) {
                        return new Promise((function(resolve) {
                            __SL_$__(item).one("animationend", (function() {
                                resolve();
                            }));
                        }));
                    }))).then((function() {
                    ...
                    swiper.slides.each((function() {
                        var $el = __SL_$__(this);
                        if ($el.hasClass(swiper.params.slideActiveClass)) $el.addClass(classes.animateOut).one("transitionend", (function() {
        ...
        function slideshow_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        var SLIDE_ACTIVE_CLASS = "is-selected";
        var selectors = {
        ...
        var Slideshow = function() {
            function Slideshow(container) {
                ...
                slideshow_defineProperty(this, "container", null);
                slideshow_defineProperty(this, "settings", {});
                slideshow_defineProperty(this, "sectionId", "");
                this.container = container;
                this.sectionId = container.data("section-id");
                try {
                    this.settings = JSON.parse(__SL_$__("#Slideshow-data-".concat(this.sectionId)).text());
                } catch (err) {}
                this.init();
            }
            _createClass(Slideshow, [ {
                key: "init",
                value: function() {
                    var container = this.container, sectionId = this.sectionId, settings = this.settings;
                    ...
                    this.swiper = new core_class["default"]("#Slideshow-".concat(sectionId), swiperOptions);
                    var $flickityViewport = container.find(selectors.flickityViewport);
                    if ($flickityViewport.hasClass(slideshow_classes.isNatural)) {
                        var $image = container.find('[data-swiper-slide-index="0"]').find(selectors.image).eq(0);
                        if ($image.data("aspectratio")) return;
                        var src = $image.data("aspectratio-url");
                        var image = new Image;
                        image.src = src;
                        image.onload = function(e) {
                            var target = e.target;
                            var aspectRatio = target.height / target.width * 100;
                            $flickityViewport.prepend(__SL_$__("<style />").text("\n          @media only screen and (min-width: 769px) {\n            .natural--".concat(sectionId, " {\n              padding-top: ").concat(aspectRatio, "% !important;\n            }\n          }\n        ")));
                        };
                    }
                    if ($flickityViewport.hasClass(slideshow_classes.isNaturalMobile)) {
                        var $mobileImage = container.find(selectors.imageMobile);
                        var _src = $mobileImage.data("aspectratio-url");
                        if ($mobileImage.data("aspectratio")) return;
                        if (!_src) {
                            var $pcImage = container.find('[data-swiper-slide-index="0"]').find(selectors.image).eq(0);
                            if ($pcImage.data("aspectratio")) return;
                            _src = $pcImage.data("aspectratio-url");
                        }
                        if (!_src) return;
                        ...
                        _image.onload = function(e) {
                            var target = e.target;
                            var aspectRatio = target.height / target.width * 100;
                            $flickityViewport.prepend(__SL_$__("<style />").text("\n          @media only screen and (max-width: 768px) {\n            .natural-mobile--".concat(sectionId, " {\n              padding-top: ").concat(aspectRatio, "% !important;\n            }\n          }\n        ")));
                        };
                    }
                }
            }, {
        ...
        var SlideshowSection = function() {
            function SlideshowSection(container) {
                ...
                slideshow_defineProperty(this, "slideshow", null);
            ...
            _createClass(SlideshowSection, [ {
                ...
                key: "onBlockSelect",
                value: function(e) {
                    var _e$detail$index = e.detail.index, index = void 0 === _e$detail$index ? null : _e$detail$index;
        ...
        slideshow_defineProperty(SlideshowSection, "type", "slideshow");
