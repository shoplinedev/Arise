(() => {
    var __webpack_modules__ = {
        ...
        "../shared/browser/components/hbs/shared/components/tooltip/index.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            var lodash_throttle__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("../shared/browser/node_modules/lodash/throttle.js");
            var lodash_throttle__WEBPACK_IMPORTED_MODULE_15___default = __webpack_require__.n(lodash_throttle__WEBPACK_IMPORTED_MODULE_15__);
            ...
            var calculationPosition = function($target, $tooltip) {
                ...
                var $doc = __SL_$__(document);
                var scrollTop = $doc.scrollTop();
                var scrollLeft = $doc.scrollLeft();
                var left;
                var x;
                var screenWidth = __SL_$__(window).width();
            ...
            var Tooltip = function() {
                ...
                _createClass(Tooltip, [ {
                    ...
                    value: function() {
                        var _this = this;
                        this.walk();
                        var calc = lodash_throttle__WEBPACK_IMPORTED_MODULE_15___default()((function() {
                            _this.$tooltips.forEach((function(tooltip) {
                                return _this.setPosition(__SL_$__(tooltip), _this.$target);
                            }));
                        }));
                        __SL_$__(document).scroll((function() {
                            if (_this.isShow) calc();
                        }));
                        __SL_$__(window).resize((function() {
                            if (_this.isShow) calc();
                        }));
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.$target.each((function(index, item) {
                            var $item = __SL_$__(item);
                            var $tooltip = __SL_$__(template);
                    ...
                    value: function($tooltip, $target) {
                        ...
                        var events = {
                            hover: function() {
                                __SL_$__(document).off(".".concat(_this3.clickEventId));
                            ...
                            click: function() {
                                ...
                                __SL_$__(document).on("click.".concat(_this3.clickEventId), (function(event) {
                                    var $tar = __SL_$__(event.target);
                    ...
                    value: function(_ref) {
                        ...
                        if (void 0 !== title || null !== title) {
                            ...
                            this.$tooltips.forEach((function(item) {
                                __SL_$__(item).find(".".concat(CONTENT_CLASSNAME)).html(title);
                            }));
                        }
                        if (trigger) {
                    ...
                    value: function(title) {
                        this.$tooltips.forEach((function(item) {
                            __SL_$__(item).removeClass(HIDDEN_CLASSNAME).find(".".concat(CONTENT_CLASSNAME)).html(title);
                        }));
                        this.isShow = true;
                    }
                }, {
                    ...
                    key: "install",
                    value: function() {
                        var __SL_$__ = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : window.jQuery;
                        if (!__SL_$__.fn.tooltip) __SL_$__.fn.extend({
        ...
        "../shared/browser/utils/report/index.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            var reportCommonParams = [ false, false, false, true ];
            var Hidoo = function() {
                function Hidoo() {
                ...
                _createClass(Hidoo, [ {
                    ...
                    value: function(type, data, eventID, extra) {
                        ...
                        switch (type) {
                          case "Purchase":
                            window.HdSdk && (_window$HdSdk$shopTra = window.HdSdk.shopTracker).report.apply(_window$HdSdk$shopTra, [ hdEventId || "80000101", _hiido_objectSpread(_hiido_objectSpread(_hiido_objectSpread(_hiido_objectSpread({
                                iframe_id: 1
                            }, eventID), params), fbParams), rest) ].concat(reportCommonParams));
                            return this;
                        ...
                        if (event) {
                            var _window$HdSdk$shopTra2, _window$HdSdk$shopTra3;
                            params = _hiido_objectSpread(_hiido_objectSpread(_hiido_objectSpread({
                                iframe_id: 1
                            }, params), eventID), fbParams);
                            window.HdSdk && (_window$HdSdk$shopTra2 = window.HdSdk.shopTracker).report.apply(_window$HdSdk$shopTra2, [ "80000".concat(event), params ].concat(reportCommonParams));
                            window.HdSdk && (_window$HdSdk$shopTra3 = window.HdSdk.shopTracker).report.apply(_window$HdSdk$shopTra3, [ "90000".concat(event), fbParams ].concat(reportCommonParams));
                        } else {
                            var _window$HdSdk$shopTra4;
                            window.HdSdk && (_window$HdSdk$shopTra4 = window.HdSdk.shopTracker).report.apply(_window$HdSdk$shopTra4, [ "90000000", fbParams ].concat(reportCommonParams));
                        }
                        return this;
                    }
                }, {
                    ...
                    value: function(type, params, eventID, extra) {
                        if (ClickType[type]) {
                            var _window$HdSdk$shopTra5;
                            Hidoo.fbChecker();
                            window.HdSdk && (_window$HdSdk$shopTra5 = window.HdSdk.shopTracker).report.apply(_window$HdSdk$shopTra5, [ "80000".concat(ClickType[type]), _hiido_objectSpread(_hiido_objectSpread(_hiido_objectSpread({
                                iframe_id: 1
                            }, params), eventID), Hidoo.getFbParams()) ].concat(reportCommonParams));
            ...
            Hidoo.fbChecker = function() {
                ...
                Hidoo.FB_CHECKER_INFO.timmer = setInterval((function() {
                    if (js_cookie_default().get("_fbp")) {
                        var _window$HdSdk$shopTra6;
                        clearInterval(Hidoo.FB_CHECKER_INFO.timmer);
                        window.HdSdk && (_window$HdSdk$shopTra6 = window.HdSdk.shopTracker).report.apply(_window$HdSdk$shopTra6, [ "93000000", _hiido_objectSpread({
                            _start: now,
                            _end: Date.now(),
                            _duration: Date.now() - now,
                            _fbq: window.fbq.version,
                            iframe_id: 1
                        }, Hidoo.getFbParams()) ].concat(reportCommonParams));
                    }
