(() => {
    var __webpack_modules__ = {
        ...
        "./src/assets/commons/jquery.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
            "use strict";
            var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/jquery/dist/jquery.js");
            var jquery__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
            var _components_tooltip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/assets/commons/components/tooltip/index.js");
            window.$ = jquery__WEBPACK_IMPORTED_MODULE_0___default();
            window.jQuery = jquery__WEBPACK_IMPORTED_MODULE_0___default();
            _components_tooltip__WEBPACK_IMPORTED_MODULE_1__["default"].install(window.$);
            window.__SL_$__ = window.$ || window.jQuery;
        },
        "../shared/browser/components/hbs/shared/components/tooltip/index.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            class Tooltip {
                ...
                toggle({title, trigger}) {
                    if (void 0 !== title || null !== title) {
                        ...
                        this.$tooltips.forEach((item => {
                            __SL_$__(item).find(`.${CONTENT_CLASSNAME}`).html(title);
                        }));
                    }
                    if (trigger) {
                ...
                show(title) {
                    this.$tooltips.forEach((item => {
                        __SL_$__(item).removeClass(HIDDEN_CLASSNAME).find(`.${CONTENT_CLASSNAME}`).html(title);
                    }));
                    this.isShow = true;
                }
                hide() {
                    this.$tooltips.forEach((item => {
                        __SL_$__(item).addClass(HIDDEN_CLASSNAME);
                    }));
                    this.isShow = false;
                }
                destroy() {
        ...
        "../shared/browser/node_modules/dayjs/plugin/timezone.js": function(module) {
            !function(t, e) {
                true ? module.exports = e() : 0;
            }(0, (function() {
                "use strict";
        ...
        "../shared/browser/node_modules/dayjs/plugin/utc.js": function(module) {
            !function(t, i) {
        ...
        "../shared/browser/utils/report/index.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            var utc = __webpack_require__("../shared/browser/node_modules/dayjs/plugin/utc.js");
            var utc_default = __webpack_require__.n(utc);
            var timezone = __webpack_require__("../shared/browser/node_modules/dayjs/plugin/timezone.js");
            ...
            class Hidoo {
                ...
                load(type, data, eventID, extra) {
                    ...
                    } else window.HdSdk && window.HdSdk.shopTracker.report("90000000", fbParams, ...reportCommonParams);
                    return this;
                }
