...
window.SLM['product/commons/js/get-rate-snippet.js'] = window.SLM['product/commons/js/get-rate-snippet.js'] || function () {
  const _exports = {};
  ...
  function getRateSnippet(options = {}) {
    ...
    const starHtml = Array.from({
      ...
      if (allowHalf && index < value && value < currentValue) {
  ...
  _exports.default = getRateSnippet;
  return _exports;
}();