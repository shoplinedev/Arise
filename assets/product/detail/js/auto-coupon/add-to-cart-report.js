...
window.SLM['product/detail/js/auto-coupon/add-to-cart-report.js'] = window.SLM['product/detail/js/auto-coupon/add-to-cart-report.js'] || function () {
  const _exports = {};
  const { nullishCoalescingOperator, get, get_func } = window['SLM']['theme-shared/utils/syntax-patch.js'];
  const getSkuAttributeNames = window['SLM']['product/detail/js/auto-coupon/get-sku-attribute-names.js'].default;
