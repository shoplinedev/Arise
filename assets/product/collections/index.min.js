...
(self["webpackChunkArise"] = self["webpackChunkArise"] || []).push([ [ "product-collection" ], {
    "./node_modules/core-js/modules/es.promise.finally.js": (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    "./src/assets/product/collections/main.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
        ...
        function infiniteScrollList_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function infiniteScrollList_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) infiniteScrollList_ownKeys(Object(source), true).forEach((function(key) {
                    infiniteScrollList_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else infiniteScrollList_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function infiniteScrollList_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function infiniteScrollList_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function infiniteScrollList_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function infiniteScrollList_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) infiniteScrollList_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) infiniteScrollList_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        ...
        var InfiniteScrollList = function() {
            function InfiniteScrollList(options) {
                infiniteScrollList_classCallCheck(this, InfiniteScrollList);
                this.loading = false;
            ...
            infiniteScrollList_createClass(InfiniteScrollList, [ {
                key: "deletePageNumParamByUrl",
                value: function() {
                    var hasPageNumParam = (0, url.getUrlQuery)("page_num");
                    if (hasPageNumParam) {
                        var fixUrl = (0, url.delParam)("page_num");
                ...
                value: function(options) {
                    ...
                    var infiniteScrollAnchor = __SL_$__(".product-list-infinite-scroll-anchor");
                    var isInitLastPage = infiniteScrollAnchor.length <= 0;
                    if (isInitLastPage) return;
                    var _options = infiniteScrollList_objectSpread({
                ...
                key: "listerUpdateSection",
                value: function() {
                    var bindInit = this.init.bind(this);
                ...
                value: function() {
                    var _this2 = this;
                    var observeEle = __SL_$__(".product-list-infinite-scroll-anchor");
                    var appendEle = __SL_$__(".product-infinite-list-container");
                    var lastPageEle = __SL_$__(".product-infinite-list-lastPage");
                    var isLoadMoreLastPage = lastPageEle.length > 0;
                    if (isLoadMoreLastPage) this.anchorObserverTarget.disconnect();
                    if (this.loading || isLoadMoreLastPage) return;
                    var pageNum = Number(observeEle.attr("data-pageNum")) + 1;
                    this.handleLoading(true);
                    var requestUrl = (0, url.changeURLArg)(window.location.search, "page_num", pageNum, false);
                    var collectionPath = window.location.pathname;
                    axios_default().get("".concat(collectionPath).concat(requestUrl, "&view=ajax&isJsonSettings=true&loadMore=true")).then((function(res) {
                        var data = res.data;
                        if (data) {
                            var children = __SL_$__(data).children();
                        ...
                        console.error("InfiniteScrollList ".concat(err));
                    }))["finally"]((function() {
        ...
        var CollectionsPage = function() {
            function CollectionsPage() {
                ...
                sort();
                var isListInfiniteScroll = __SL_$__(".product-list-is-infinite-scroll-mode").length > 0;
