    ...
    "./src/assets/product/recently-viewed/index.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
            ...
            _getProductsInfo = _asyncToGenerator(regeneratorRuntime.mark((function _callee(excludeProductIds, productIds) {
                ...
                return regeneratorRuntime.wrap((function(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        recentlyProductIds = (0, syntax_patch.nullishCoalescingOperator)(productIds, window.localStorage.getItem("history_browse_products"));
                        realRecentlyProductIds = recentlyProductIds && recentlyProductIds.split(",").filter((function(item) {
                      ...
                      case 6:
                        ...
                        sortProductInfoVoList = recentlyProductIds.split(",").map((function(item) {
                            var hitProduct = data && data.productInfoVoList.find((function(_item) {
        ...
        function _fetchRecentlySection() {
            _fetchRecentlySection = _asyncToGenerator(regeneratorRuntime.mark((function _callee2(_ref) {
                var _ref$sectionName, sectionName, excludeProductIds, productIds, context, _ref$mode, mode, productInfoVoList, query, queryPath, _yield$http$post, data, html;
                    ...
                    while (1) switch (_context2.prev = _context2.next) {
                      ...
                      case 3:
                        ...
                        if ("SINGLE" === mode) {
                            ...
                            query.mode = mode;
                            queryPath = "/page".concat(state_selector.SL_State.get("request.uri.url") || window.location.pathname + window.location.search);
                        }
                        _context2.next = 9;
                      ...
                      case 9:
                        ...
                        html = "SINGLE" === mode ? data && data.html : data;
                        return _context2.abrupt("return", (0, syntax_patch.nullishCoalescingOperator)(html, ""));
        ...
        function initRecentlyReport(wrapperSelector, mountDom) {
            var report = new baseReport.BaseReport;
            report.view({
            ...
            var recentlyItemCls = ".__sl-custom-track-product-recently-viewed-item";
            var itemList = mountDom.querySelectorAll("".concat(recentlyItemCls));
            if (itemList && itemList.length > 0) {
                report.view({
                    targetList: itemList,
                    customParams: function(target) {
                        var spuId = target.dataset.id;
                        return {
                            module: 108,
                            component: 101,
                ...
                __SL_$__("body").on("click", "".concat(recentlyItemCls), (function() {
                    var content_ids = __SL_$__(this).attr("data-id");
                    var sku_id = __SL_$__(this).attr("data-sku-id");
                    var content_name = __SL_$__(this).attr("data-name");
                    var currency = state_selector.SL_State.get("storeInfo.currency");
                    var value = __SL_$__(this).attr("data-price");
                    var position = Number(__SL_$__("".concat(recentlyItemCls)).index(__SL_$__(this))) + 1;
                    var customParams = {
                        content_ids,
                        sku_id,
                        content_name,
        ...
        function _initProductRecentlyList() {
            _initProductRecentlyList = _asyncToGenerator(regeneratorRuntime.mark((function _callee3(_ref2) {
                var selector, sectionName, excludeProductIds, productIds, context, mode, data, mountDom;
