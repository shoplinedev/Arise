(() => {
    ...
    (() => {
        ...
        function l(window, document, Date) {
            ...
            var loader = function() {
                ...
                var checkElements = function() {
                    ...
                    var lazyloadElems = [].concat(_toConsumableArray(originElement), _toConsumableArray(extraElements));
                ...
                var switchLoadingClass = function(e) {
                    ...
                    lazysizes.extraElements = lazysizes.extraElements.filter((function(item) {
                        return item !== elem;
                    }));
        ...
        function _toArray(arr) {
            return _arrayWithHoles(arr) || util_iterableToArray(arr) || util_unsupportedIterableToArray(arr) || _nonIterableRest();
        }
        function _slicedToArray(arr, i) {
            return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || util_unsupportedIterableToArray(arr, i) || _nonIterableRest();
        }
        ...
        function util_toConsumableArray(arr) {
            return util_arrayWithoutHoles(arr) || util_iterableToArray(arr) || util_unsupportedIterableToArray(arr) || util_nonIterableSpread();
        }
        ...
        function util_unsupportedIterableToArray(o, minLen) {
            ...
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return util_arrayLikeToArray(o, minLen);
        }
        function util_iterableToArray(iter) {
            if ("undefined" !== typeof Symbol && null != iter[Symbol.iterator] || null != iter["@@iterator"]) return Array.from(iter);
        }
        function util_arrayWithoutHoles(arr) {
            if (Array.isArray(arr)) return util_arrayLikeToArray(arr);
        }
        ...
        var transformSrcset = function(srcset, transformer) {
            return srcset.split(",").filter((function(str) {
                ...
                return concatStr(transformer.apply(void 0, util_toConsumableArray(str.trim().split(" "))), " ");
            })).join(",");
        };
        var SLFile = function() {
            function SLFile(url) {
            ...
            _createClass(SLFile, [ {
                key: "toString",
                value: function() {
                    this.uri.pathname = concatStr([].concat(util_toConsumableArray(this.paths.slice(0, -1)), [ concatStr([ [ this.name ].concat(util_toConsumableArray(this.modifiers)).join("_"), this.suffix ], ".") ]), "/");
        ...
        const image_gif_poster = function(event) {
            ...
            if (isElementType(element, "img")) {
                ...
                var setImageData = function(_ref2) {
                    ...
                    if (sizes) img.sizes = "number" === typeof sizes ? "".concat(sizes, "px") : sizes;
        ...
        var defaultBreakpoint = [ 375, 540, 720, 900, 1080, 1296, 1512, 1728, 1944, 2160, 2660, 2960, 3260, 3860 ];
        var filterBreakpoints = function(imageWidth, breakpoints) {
            if (!imageWidth) return breakpoints;
            var newPoints = breakpoints.findIndex((function(point) {
                return point > imageWidth;
            }));
            return breakpoints.slice(0, newPoints + 1);
        };
        var createImageUrl = function(_ref) {
            var url = _ref.url, width = _ref.width;
            if (!width) return url;
        ...
        const auto_breakpoint = function(event) {
            var element = event.target;
            var isAuto = element.getAttribute(EnumAttributes.AutoSize);
            var srcset = element.getAttribute(EnumAttributes.Srcset);
            var src = element.getAttribute(EnumAttributes.Src);
            if (isAuto && !srcset && isS3FileUrl(src)) {
                var file = new SLFile(src);
                var imageWidth = file.querys.get("w");
                var breakpoints = filterBreakpoints(imageWidth, defaultBreakpoint);
                var newSrcset = breakpoints.map((function(point) {
                    return "".concat(createImageUrl({
                        url: src,
                        width: point
                    }), " ").concat(point, "w");
                }));
        ...
        function lazysizes_toConsumableArray(arr) {
            return lazysizes_arrayWithoutHoles(arr) || lazysizes_iterableToArray(arr) || lazysizes_unsupportedIterableToArray(arr) || lazysizes_nonIterableSpread();
        }
        function lazysizes_nonIterableSpread() {
            throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        }
        function lazysizes_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ("string" === typeof o) return lazysizes_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            if ("Object" === n && o.constructor) n = o.constructor.name;
            if ("Map" === n || "Set" === n) return Array.from(o);
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return lazysizes_arrayLikeToArray(o, minLen);
        }
        function lazysizes_iterableToArray(iter) {
            if ("undefined" !== typeof Symbol && null != iter[Symbol.iterator] || null != iter["@@iterator"]) return Array.from(iter);
        }
        function lazysizes_arrayWithoutHoles(arr) {
            if (Array.isArray(arr)) return lazysizes_arrayLikeToArray(arr);
        }
        function lazysizes_arrayLikeToArray(arr, len) {
            if (null == len || len > arr.length) len = arr.length;
            for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
            return arr2;
        }
        var BeforeUnveilEvent = "lazybeforeunveil";
        ...
        function initLazysizes() {
            ...
            HTMLElement.prototype.__updateLazyExtraElements__ = function() {
                var _window$lazySizes$ext;
                var imgs = [];
                if (this.shadowRoot) imgs.push.apply(imgs, lazysizes_toConsumableArray(this.shadowRoot.querySelectorAll(".".concat(EnumAttributes.LazyClass))));
                imgs.push.apply(imgs, lazysizes_toConsumableArray(this.querySelectorAll(".".concat(EnumAttributes.LazyClass))));
                (_window$lazySizes$ext = window.lazySizes.extraElements).push.apply(_window$lazySizes$ext, imgs);
                window.lazySizes.loader.checkElems();
                return imgs;
            };
            HTMLElement.prototype.__removeLazySizesListener__ = function(elements) {
                window.lazySizes.extraElements.filter((function(item) {
