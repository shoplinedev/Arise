    ...
    (() => {
        ...
        class DeleteAccount extends customer {
            ...
            showAccountTips(account) {
                const content = this.mode === PHONE ? t("userCenter.deleteAccount.verifyPhoneMessage", {
                    phone: account
                }) : t("userCenter.deleteAccount.verifyEmailMessage", {
                    email: account
                });
            ...
            showDeleteAccountMessage(account) {
                this.$tips.html(this.mode !== PHONE ? t("userCenter.deleteAccount.verifyEmailMessage", {
                    email: account
                }) : t("userCenter.deleteAccount.verifyPhoneMessage", {
                    phone: account
                }));
                this.$tips.show();
            }
            ...
            async nextStep(currentTime) {
                ...
                $(".delete-account__notice .submit-button").click((async e => {
                    $(e.target).addClass(delete_account_BUTTON_LOADING_CLASS);
                    try {
                    ...
                    $(e.target).removeClass(delete_account_BUTTON_LOADING_CLASS);
                }));
                $(".delete-account__notice .delete-account__deadline").html(t("userCenter.deleteAccount.deadline", {
        ...
        class Account extends card {
            ...
            toResetPassword(path, token) {
                ...
                if (!phone && !email) {
                    toast.init({
                        content: t("userCenter.account.reset-password-error")
                    });
                    return;
                }
            ...
            refresh(nickname) {
                ...
                this.$nickname.find(".account-item__value").text(nickname || t("userCenter.account.notSet"));
                this.$nickname.find(".account-item__modify--error").hide();
            }
        }
        ...
        const tPc = (path, hash) => t(`userCenter.datePicker.pc.${path}`, hash);
        const tMobile = (path, hash) => t(`userCenter.datePicker.mobile.${path}`, hash);
        const locale = {
            pc: {
                days: [ tPc("days0"), tPc("days1"), tPc("days2"), tPc("days3"), tPc("days4"), tPc("days5"), tPc("days6") ],
                daysShort: [ tPc("daysShort0"), tPc("daysShort1"), tPc("daysShort2"), tPc("daysShort3"), tPc("daysShort4"), tPc("daysShort5"), tPc("daysShort6") ],
                daysMin: [ tPc("daysMin0"), tPc("daysMin1"), tPc("daysMin2"), tPc("daysMin3"), tPc("daysMin4"), tPc("daysMin5"), tPc("daysMin6") ],
                months: [ tPc("months0"), tPc("months1"), tPc("months2"), tPc("months3"), tPc("months4"), tPc("months5"), tPc("months6"), tPc("months7"), tPc("months8"), tPc("months9"), tPc("months10"), tPc("months11") ],
                monthsShort: [ tPc("monthsShort0"), tPc("monthsShort1"), tPc("monthsShort2"), tPc("monthsShort3"), tPc("monthsShort4"), tPc("monthsShort5"), tPc("monthsShort6"), tPc("monthsShort7"), tPc("monthsShort8"), tPc("monthsShort9"), tPc("monthsShort10"), tPc("monthsShort11") ],
                today: tPc("today"),
                clear: tPc("clear"),
                dateFormat: tPc("dateFormat"),
                timeFormat: tPc("timeFormat"),
                firstDay: parseInt(tPc("firstDay"), 10)
            },
            mobile: {
                title: tMobile("title"),
                cancel: tMobile("cancel"),
                confirm: tMobile("confirm"),
                year: "",
                month: "",
                day: "",
                hour: "",
        ...
        const GENDER_MAP = {
            1: t("userCenter.personal.gender-male"),
            2: t("userCenter.personal.gender-female"),
            3: t("userCenter.personal.gender-secret")
        };
        class Personal extends card {
            ...
            onSave() {
                ...
                return updateMemberInfo({
                    ...
                    if (this.formData.birthday) $(this.birthdaySelector).text(dayjs_min_default()(this.formData.birthday).format("YYYY-MM-DD"));
                    if (GENDER_MAP[gender]) $(this.genderSelector).text(GENDER_MAP[gender]);
