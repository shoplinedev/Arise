(() => {
    ...
    (() => {
        ...
        var bind_sendBindPhoneVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/mobile/bind/sendSms.do", {
                params
            });
        };
        var sendBindEmailVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/email/bind/sendCode.do", {
                params
            });
        };
        var updateBindInfo = function(type) {
            return request_request.get("/user/front/userinfo/sync/".concat(type));
        };
        var verifyBindPhoneVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/mobile/bind/bind.do", {
                params
            });
        };
        var verifyBindEmailVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/email/bind/bind.do", {
                params
            });
        };
        ...
        function bind_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function bind_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) bind_ownKeys(Object(source), true).forEach((function(key) {
                    bind_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else bind_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function bind_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        var reportBindPhone = function(config) {
            return reportV2(bind_objectSpread({
                page: pageMap.Bind.phone
            }, config));
        };
        var reportBindEmail = function(config) {
            return reportV2(bind_objectSpread({
                page: pageMap.Bind.email
            }, config));
        };
        var reportBindPhoneToUserCenter = function() {
            reportBindPhone({
                module: Module.normal,
                component: 101,
                action_type: ActionType.click,
        ...
        var reportBindEmailToUserCenter = function() {
            reportBindEmail({
                module: Module.normal,
                component: 101,
                action_type: ActionType.click,
        ...
        function _superPropBase(object, property) {
            while (!Object.prototype.hasOwnProperty.call(object, property)) {
                object = account_getPrototypeOf(object);
        ...
        var PHONE = "phone";
        var BindAccount = function(_BaseCustomer) {
            account_inherits(BindAccount, _BaseCustomer);
            var _super = account_createSuper(BindAccount);
            function BindAccount(_ref) {
                var _this;
                var id = _ref.id, form = _ref.form;
                account_classCallCheck(this, BindAccount);
                _this = _super.call(this, {
                    id,
            ...
            account_createClass(BindAccount, [ {
                key: "init",
                value: function() {
                    this.initForm();
                }
                ...
                value: function() {
                    ...
                    var account = getAccountFieldType(mode);
                    var FIELD_TYPES = [ account, {
                        type: "verifycode",
                        on: {
                            send: function() {
                ...
                key: "sendVerifyCode",
                value: function() {
                    var _sendVerifyCode = account_asyncToGenerator(regeneratorRuntime.mark((function _callee2() {
                        var _this4 = this;
                        var mode, params, formValue, acct;
                        return regeneratorRuntime.wrap((function(_context2) {
                            while (1) switch (_context2.prev = _context2.next) {
                              case 0:
                                mode = this.form.queryParams.mode;
                                params = this.form.UDBParams;
                                formValue = this.bindForm && this.bindForm.getFormValue();
                                acct = formValue[mode] || formValue.username;
                                _context2.next = 6;
                                return wrapArmorCaptcha({
                                    onSendCode: function() {
                                        var _onSendCode = account_asyncToGenerator(regeneratorRuntime.mark((function _callee(captchaToken) {
                                            var res, verifyCodePrarms, _verifyCodePrarms;
                                            return regeneratorRuntime.wrap((function(_context) {
                                                while (1) switch (_context.prev = _context.next) {
                                                  case 0:
                                                    res = {};
                                                    ...
                                                    verifyCodePrarms = _get(account_getPrototypeOf(BindAccount.prototype), "formatRequestBody", _this4).call(_this4, account_objectSpread(account_objectSpread({}, params), {}, {
                                                        mobile: acct,
                                                        captcha: captchaToken
                                                    }));
                                                    _context.next = 5;
                                                    return bind_sendBindPhoneVerificationCode(verifyCodePrarms);
                                                  ...
                                                  case 8:
                                                    _verifyCodePrarms = _get(account_getPrototypeOf(BindAccount.prototype), "formatRequestBody", _this4).call(_this4, account_objectSpread(account_objectSpread({}, params), {}, {
                                                        email: acct
                                                    }));
                                                    _context.next = 11;
                                                    return sendBindEmailVerificationCode(_verifyCodePrarms);

                                                  case 11:
                                                    res = _context.sent;

                                                  case 12:
                                                    _get(account_getPrototypeOf(BindAccount.prototype), "updateToken", _this4).call(_this4, params, {
                                                        stoken: res.stoken
                                                    });
                ...
                key: "onSubmit",
                value: function() {
                    var _onSubmit = account_asyncToGenerator(regeneratorRuntime.mark((function _callee3() {
                        var data, mode, params, _args3 = arguments;
                        return regeneratorRuntime.wrap((function(_context3) {
                            while (1) switch (_context3.prev = _context3.next) {
                              case 0:
                                data = _args3.length > 0 && void 0 !== _args3[0] ? _args3[0] : {};
                                mode = this.form.queryParams.mode;
                                params = this.form.UDBParams;
                                if (!(mode === PHONE)) {
                                    _context3.next = 8;
                                ...
                                _context3.next = 6;
                                return verifyBindPhoneVerificationCode(_get(account_getPrototypeOf(BindAccount.prototype), "formatRequestBody", this).call(this, account_objectSpread(account_objectSpread({}, params), {}, {
                                    mobile: data[mode],
                              ...
                              case 8:
                                _context3.next = 10;
                                return verifyBindEmailVerificationCode(_get(account_getPrototypeOf(BindAccount.prototype), "formatRequestBody", this).call(this, account_objectSpread(account_objectSpread({}, params), {}, {
                                    email: data[mode],
                              ...
                              case 10:
                                _context3.next = 12;
                                return updateBindInfo("phone" === mode ? "2" : "1");
        ...
        function bind_typeof(obj) {
            "@babel/helpers - typeof";
            if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) bind_typeof = function(obj) {
                return typeof obj;
            }; else bind_typeof = function(obj) {
                return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
            };
            return bind_typeof(obj);
        }
        function bind_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
            try {
                var info = gen[key](arg);
                var value = info.value;
            } catch (error) {
        ...
        function bind_asyncToGenerator(fn) {
            return function() {
                var self = this, args = arguments;
                return new Promise((function(resolve, reject) {
                    var gen = fn.apply(self, args);
                    function _next(value) {
                        bind_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
                    }
                    function _throw(err) {
                        bind_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
                    }
                    _next(void 0);
                }));
            };
        }
        function biz_bind_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function biz_bind_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) biz_bind_ownKeys(Object(source), true).forEach((function(key) {
                    biz_bind_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else biz_bind_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function biz_bind_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function bind_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function bind_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function bind_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) bind_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) bind_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        function bind_get(target, property, receiver) {
            if ("undefined" !== typeof Reflect && Reflect.get) bind_get = Reflect.get; else bind_get = function(target, property, receiver) {
                var base = bind_superPropBase(target, property);
                if (!base) return;
                var desc = Object.getOwnPropertyDescriptor(base, property);
                if (desc.get) return desc.get.call(receiver);
                return desc.value;
            };
            return bind_get(target, property, receiver || target);
        }
        function bind_superPropBase(object, property) {
            while (!Object.prototype.hasOwnProperty.call(object, property)) {
                object = bind_getPrototypeOf(object);
                if (null === object) break;
            }
            return object;
        }
        function bind_inherits(subClass, superClass) {
            if ("function" !== typeof superClass && null !== superClass) throw new TypeError("Super expression must either be null or a function");
            subClass.prototype = Object.create(superClass && superClass.prototype, {
                constructor: {
                    value: subClass,
            ...
            if (superClass) bind_setPrototypeOf(subClass, superClass);
        }
        function bind_setPrototypeOf(o, p) {
            bind_setPrototypeOf = Object.setPrototypeOf || function(o, p) {
                o.__proto__ = p;
                return o;
            };
            return bind_setPrototypeOf(o, p);
        }
        function bind_createSuper(Derived) {
            var hasNativeReflectConstruct = bind_isNativeReflectConstruct();
            return function() {
                var result, Super = bind_getPrototypeOf(Derived);
                if (hasNativeReflectConstruct) {
                    var NewTarget = bind_getPrototypeOf(this).constructor;
                    result = Reflect.construct(Super, arguments, NewTarget);
                } else result = Super.apply(this, arguments);
                return bind_possibleConstructorReturn(this, result);
            };
        }
        function bind_possibleConstructorReturn(self, call) {
            if (call && ("object" === bind_typeof(call) || "function" === typeof call)) return call;
            return bind_assertThisInitialized(self);
        }
        function bind_assertThisInitialized(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }
        function bind_isNativeReflectConstruct() {
            if ("undefined" === typeof Reflect || !Reflect.construct) return false;
            if (Reflect.construct.sham) return false;
            if ("function" === typeof Proxy) return true;
            try {
        ...
        function bind_getPrototypeOf(o) {
            bind_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
                return o.__proto__ || Object.getPrototypeOf(o);
            };
            return bind_getPrototypeOf(o);
        }
        var Bind = function(_Customer) {
            bind_inherits(Bind, _Customer);
            var _super = bind_createSuper(Bind);
            function Bind(_ref) {
                var _this;
                var _ref$id = _ref.id, id = void 0 === _ref$id ? "customer-bind" : _ref$id;
                bind_classCallCheck(this, Bind);
                _this = _super.call(this, {
                    id,
                    formType: "bind"
                });
            ...
            bind_createClass(Bind, [ {
                key: "init",
                value: function() {
                    this.$tips = $("#".concat(this.formId, " .customer__tips"));
                    this.queryParams = biz_bind_objectSpread(biz_bind_objectSpread({}, this.configs), {}, {
                        mode: this.query.mode
                    });
                    ...
                    this.showAccountTips(bind_get(bind_getPrototypeOf(Bind.prototype), "formatterMask", this).call(this, params));
                    this.initForm();
                    this.bindEvents();
                }
            }, {
                ...
                value: function() {
                    var _this3 = this;
                    $("#".concat(this.formId, " .customer__footer-link .customer--link")).click((function(e) {
                        _this3.backToUserCenter(e);
                    }));
                }
            }, {
                key: "backToUserCenter",
                value: function() {
                    var mode = this.query.mode;
                    var modeToReportEvent = {
                ...
                key: "sendVerifyCode",
                value: function() {
                    var _sendVerifyCode = bind_asyncToGenerator(regeneratorRuntime.mark((function _callee2() {
                        var _this5 = this;
                        var _this$queryParams, type, mode, params;
                        return regeneratorRuntime.wrap((function(_context2) {
                            while (1) switch (_context2.prev = _context2.next) {
                              case 0:
                                _this$queryParams = this.queryParams, type = _this$queryParams.type, mode = _this$queryParams.mode;
                                ...
                                return wrapArmorCaptcha({
                                    onSendCode: function() {
                                        var _onSendCode = bind_asyncToGenerator(regeneratorRuntime.mark((function _callee(captchaToken) {
                                            var _yield$sendUniversalV, lastStoken;
                                            return regeneratorRuntime.wrap((function(_context) {
                                                while (1) switch (_context.prev = _context.next) {
                                                  case 0:
                                                    _context.next = 2;
                                                    return sendUniversalVerificationCode(biz_bind_objectSpread(biz_bind_objectSpread({}, params), {}, {
                                                        captcha: captchaToken
                                                    }));
                                                  ...
                                                  case 2:
                                                    ...
                                                    bind_get(bind_getPrototypeOf(Bind.prototype), "updateToken", _this5).call(_this5, params, {
                                                        stoken: lastStoken
                                                    });
                                    ...
                                    onCaptchaVerifySuccess: function() {
                                        _this5.bindForm.formItemInstances.verifycode.triggerSendCode();
                                    }
                                });
                ...
                key: "onSubmit",
                value: function() {
                    var _onSubmit = bind_asyncToGenerator(regeneratorRuntime.mark((function _callee3() {
                        var formValue, _this$queryParams2, type, mode, params, _yield$verifyUniversa, stoken, data, _args3 = arguments;
                        return regeneratorRuntime.wrap((function(_context3) {
                            while (1) switch (_context3.prev = _context3.next) {
                              case 0:
                                formValue = _args3.length > 0 && void 0 !== _args3[0] ? _args3[0] : {};
                                _this$queryParams2 = this.queryParams, type = _this$queryParams2.type, mode = _this$queryParams2.mode;
                                params = this.UDBParams;
                                if (!("member" === type && [ "email", "phone" ].includes(mode))) {
                                    _context3.next = 11;
                                    break;
                              ...
                              case 6:
                                ...
                                bind_get(bind_getPrototypeOf(Bind.prototype), "updateToken", this).call(this, params, {
                                    stoken,
                                    oauthToken: data && data.oauthToken
                                });
                                this.verifyAccountSuccess(bind_get(bind_getPrototypeOf(Bind.prototype), "formatterMask", this).call(this, params));
                ...
                value: function() {
                    ...
                    $("#".concat(this.formId, "-account")).show();
                    this.account = new account({
                        id: "".concat(this.formId, "-account"),
                        form: this
                    });
                }
            } ]);
