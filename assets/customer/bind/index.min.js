    ...
    (() => {
        ...
        var Bind = function(_Customer) {
            ...
            bind_createClass(Bind, [ {
                ...
                value: function() {
                    var _this3 = this;
                    __SL_$__("#".concat(this.formId, " .customer__footer-link .customer--link")).click((function(e) {
                ...
                value: function() {
                    ...
                    __SL_$__("#".concat(this.formId, "-account")).show();
