                              ...
                              case 0:
                                ...
                                return wrapArmorCaptcha({
                                    onCaptureCaptcha: function() {
                                        var _onCaptureCaptcha = account_asyncToGenerator(regeneratorRuntime.mark((function _callee(captchaToken) {
                        ...
                        return regeneratorRuntime.wrap((function(_context2) {
                            while (1) switch (_context2.prev = _context2.next) {
                              case 0:
                                ...
                                return wrapArmorCaptcha({
                                    onCaptureCaptcha: function() {
                                        var _onCaptureCaptcha = bind_asyncToGenerator(regeneratorRuntime.mark((function _callee(captchaToken) {
