(() => {
        ...
        "../shared/browser/biz-com/customer/utils/url.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            function getUrlQuery(key) {
                if ("undefined" !== typeof window) {
                    ...
                    var urlParse = url.parse(decodeURIComponent(locationHref));
                    var urlQuery = urlParse && urlParse.query;
                    var urlQueryObj = querystring.parse(urlQuery);
    ...
    (() => {
        ...
        null && axios;
        var sendPhoneVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/uni/sendSms.do", {
                params
            });
        };
        var sendEmailVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/uni/sendEmailCode.do", {
                params
            });
        };
        var verifyPhoneVerificationCode = function(params) {
            return request_udbRequest.get("/udb/aq/uni/verifySms.do", {
                params
            });
        };
        var verifyEmailVerificationCode = function(params) {
        ...
        var sendUniversalVerificationCode = function(params) {
            var sendCodeFn = params._method && params._method.includes("sms") ? sendPhoneVerificationCode : sendEmailVerificationCode;
            return sendCodeFn(helpers_formatRequestBody(params));
        };
        var verifyUniversalVerificationCode = function(params, data) {
            if (params.stoken) {
                var verifyCodeFn = params._method && params._method.includes("sms") ? verifyPhoneVerificationCode : verifyEmailVerificationCode;
        ...
        var changeAccountPassword = function(params) {
            return request_udbRequest.get("/udb/aq/pwd/change/modify.do", {
                params
            });
        };
        ...
        var reports_reportV2 = function(collect) {
        ...
        var reportSignIn = function(config) {
            return reports_reportV2(sign_in_objectSpread({
        ...
        var reportSignUp = function(config) {
            return reports_reportV2(sign_up_objectSpread({
        ...
        var reportLoginModal = function(config) {
            return reports_reportV2(login_modal_objectSpread({
        ...
        var reportChangePasswordToUserCenter = function() {
            return reports_reportV2({
        ...
        var reportVerifyAccountSuccess = function() {
            reports_reportV2({
                page: 127,
                module: report_Module.normal,
                component: -999,
        ...
        function password_typeof(obj) {
            "@babel/helpers - typeof";
            if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) password_typeof = function(obj) {
                return typeof obj;
            }; else password_typeof = function(obj) {
                return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
            };
            return password_typeof(obj);
        }
        function password_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function password_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) password_ownKeys(Object(source), true).forEach((function(key) {
                    reset_password_password_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else password_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function reset_password_password_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function reset_password_password_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function reset_password_password_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function reset_password_password_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) reset_password_password_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) reset_password_password_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        ...
        function _superPropBase(object, property) {
            while (!Object.prototype.hasOwnProperty.call(object, property)) {
                object = password_getPrototypeOf(object);
                if (null === object) break;
            }
            return object;
        }
        function password_inherits(subClass, superClass) {
            if ("function" !== typeof superClass && null !== superClass) throw new TypeError("Super expression must either be null or a function");
            subClass.prototype = Object.create(superClass && superClass.prototype, {
                constructor: {
                    value: subClass,
            ...
            if (superClass) password_setPrototypeOf(subClass, superClass);
        }
        function password_setPrototypeOf(o, p) {
            password_setPrototypeOf = Object.setPrototypeOf || function(o, p) {
                o.__proto__ = p;
                return o;
            };
            return password_setPrototypeOf(o, p);
        }
        function password_createSuper(Derived) {
            var hasNativeReflectConstruct = password_isNativeReflectConstruct();
            return function() {
                var result, Super = password_getPrototypeOf(Derived);
                if (hasNativeReflectConstruct) {
        ...
        function password_possibleConstructorReturn(self, call) {
            if (call && ("object" === password_typeof(call) || "function" === typeof call)) return call;
            return password_assertThisInitialized(self);
        }
        function password_assertThisInitialized(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }
        function password_isNativeReflectConstruct() {
            if ("undefined" === typeof Reflect || !Reflect.construct) return false;
            if (Reflect.construct.sham) return false;
            if ("function" === typeof Proxy) return true;
            try {
        ...
        function password_getPrototypeOf(o) {
            password_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
                return o.__proto__ || Object.getPrototypeOf(o);
            };
            return password_getPrototypeOf(o);
        }
        var PasswordSet = function(_BaseCustomer) {
            password_inherits(PasswordSet, _BaseCustomer);
            var _super = password_createSuper(PasswordSet);
            function PasswordSet(_ref) {
                var _this;
                var id = _ref.id, form = _ref.form;
                reset_password_password_classCallCheck(this, PasswordSet);
                _this = _super.call(this, {
                    id,
                    formType: "passwordNew"
                });
                _this.form = form;
                _this.passwordForm = null;
                _this.init();
                return _this;
            }
            reset_password_password_createClass(PasswordSet, [ {
                key: "init",
                value: function() {
                    var _this2 = this;
                    var fieldTypes = [ "password", "repeatPassword" ];
                ...
                key: "onSubmit",
                value: function(data) {
                    var params = this.form.UDBParams;
                    try {
                        changeAccountPassword(_get(password_getPrototypeOf(PasswordSet.prototype), "formatRequestBody", this).call(this, password_objectSpread(password_objectSpread({}, params), {}, {
                            pwd: data.password
                        })));
                        window.location.href = "".concat(USER_CENTER).concat(window.location.search);
                    } catch (e) {
                        _get(password_getPrototypeOf(PasswordSet.prototype), "setError", this).call(this, e);
                    }
                }
            } ]);
            return PasswordSet;
        ...
        function reset_password_typeof(obj) {
            "@babel/helpers - typeof";
            if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) reset_password_typeof = function(obj) {
                return typeof obj;
            }; else reset_password_typeof = function(obj) {
                return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
            };
            return reset_password_typeof(obj);
        }
        function reset_password_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function reset_password_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) reset_password_ownKeys(Object(source), true).forEach((function(key) {
                    reset_password_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else reset_password_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function reset_password_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function reset_password_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
            try {
                var info = gen[key](arg);
                var value = info.value;
            } catch (error) {
        ...
        function reset_password_asyncToGenerator(fn) {
            return function() {
                var self = this, args = arguments;
                return new Promise((function(resolve, reject) {
                    var gen = fn.apply(self, args);
                    function _next(value) {
                        reset_password_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
                    }
                    function _throw(err) {
                        reset_password_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
                    }
                    _next(void 0);
                }));
            };
        }
        function reset_password_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function reset_password_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function reset_password_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) reset_password_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) reset_password_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        function reset_password_get(target, property, receiver) {
            if ("undefined" !== typeof Reflect && Reflect.get) reset_password_get = Reflect.get; else reset_password_get = function(target, property, receiver) {
                var base = reset_password_superPropBase(target, property);
                if (!base) return;
                var desc = Object.getOwnPropertyDescriptor(base, property);
                if (desc.get) return desc.get.call(receiver);
                return desc.value;
            };
            return reset_password_get(target, property, receiver || target);
        }
        function reset_password_superPropBase(object, property) {
            while (!Object.prototype.hasOwnProperty.call(object, property)) {
                object = reset_password_getPrototypeOf(object);
                if (null === object) break;
            }
            return object;
        }
        function reset_password_inherits(subClass, superClass) {
            if ("function" !== typeof superClass && null !== superClass) throw new TypeError("Super expression must either be null or a function");
            subClass.prototype = Object.create(superClass && superClass.prototype, {
                constructor: {
                    value: subClass,
            ...
            if (superClass) reset_password_setPrototypeOf(subClass, superClass);
        }
        function reset_password_setPrototypeOf(o, p) {
            reset_password_setPrototypeOf = Object.setPrototypeOf || function(o, p) {
                o.__proto__ = p;
                return o;
            };
            return reset_password_setPrototypeOf(o, p);
        }
        function reset_password_createSuper(Derived) {
            var hasNativeReflectConstruct = reset_password_isNativeReflectConstruct();
            return function() {
                var result, Super = reset_password_getPrototypeOf(Derived);
                if (hasNativeReflectConstruct) {
                    var NewTarget = reset_password_getPrototypeOf(this).constructor;
                    result = Reflect.construct(Super, arguments, NewTarget);
                } else result = Super.apply(this, arguments);
                return reset_password_possibleConstructorReturn(this, result);
            };
        }
        function reset_password_possibleConstructorReturn(self, call) {
            if (call && ("object" === reset_password_typeof(call) || "function" === typeof call)) return call;
            return reset_password_assertThisInitialized(self);
        }
        function reset_password_assertThisInitialized(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }
        function reset_password_isNativeReflectConstruct() {
            if ("undefined" === typeof Reflect || !Reflect.construct) return false;
            if (Reflect.construct.sham) return false;
            if ("function" === typeof Proxy) return true;
            try {
        ...
        function reset_password_getPrototypeOf(o) {
            reset_password_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
                return o.__proto__ || Object.getPrototypeOf(o);
            };
            return reset_password_getPrototypeOf(o);
        }
        var ResetPassword = function(_Customer) {
            reset_password_inherits(ResetPassword, _Customer);
            var _super = reset_password_createSuper(ResetPassword);
            function ResetPassword(_ref) {
                var _this;
                var _ref$id = _ref.id, id = void 0 === _ref$id ? "reset-password" : _ref$id;
                reset_password_classCallCheck(this, ResetPassword);
                _this = _super.call(this, {
                    id,
                    formType: "reset"
                });
            ...
            reset_password_createClass(ResetPassword, [ {
                key: "init",
                value: function() {
                    this.$tips = $("#".concat(this.formId, " .customer__tips"));
                    this.queryParams = this.configs;
                    this.showAccountTips(reset_password_get(reset_password_getPrototypeOf(ResetPassword.prototype), "formatterMask", this).call(this, this.UDBParams));
                    this.initForm();
                    $("#".concat(this.formId, " .customer__footer-link .customer--link")).click((function() {
                        return reportChangePasswordToUserCenter();
                    }));
                }
            }, {
                key: "initForm",
                ...
                key: "sendVerifyCode",
                value: function() {
                    var _sendVerifyCode = reset_password_asyncToGenerator(regeneratorRuntime.mark((function _callee2() {
                        var _this4 = this;
                        var params;
                        return regeneratorRuntime.wrap((function(_context2) {
                            while (1) switch (_context2.prev = _context2.next) {
                              case 0:
                                ...
                                return wrapArmorCaptcha({
                                    onSendCode: function() {
                                        var _onSendCode = reset_password_asyncToGenerator(regeneratorRuntime.mark((function _callee(captchaToken) {
                                            var _yield$sendUniversalV, lastStoken;
                                            return regeneratorRuntime.wrap((function(_context) {
                                                while (1) switch (_context.prev = _context.next) {
                                                  case 0:
                                                    _context.next = 2;
                                                    return sendUniversalVerificationCode(reset_password_objectSpread(reset_password_objectSpread({}, params), {}, {
                                                  ...
                                                  case 2:
                                                    ...
                                                    reset_password_get(reset_password_getPrototypeOf(ResetPassword.prototype), "updateToken", _this4).call(_this4, params, {
                                                        stoken: lastStoken
                                                    });
                                    ...
                                    onCaptchaVerifySuccess: function() {
                                        _this4.bindForm.formItemInstances.verifycode.triggerSendCode();
                                    }
                                });
                ...
                value: function(account) {
                    this.$tips.html("\n      <span>".concat(t("tips.verification-code-has-been-sent-to-your-account"), " ").concat(account, ",</span>\n      <br />\n      <span>").concat(t("tips.password-can-be-changed-after-verification"), "</span>\n    "));
                    this.$tips.show();
                }
            }, {
                key: "onSubmit",
                value: function() {
                    var _onSubmit = reset_password_asyncToGenerator(regeneratorRuntime.mark((function _callee3() {
                        var formValue, params, _yield$verifyUniversa, stoken, data, _args3 = arguments;
                        return regeneratorRuntime.wrap((function(_context3) {
                            while (1) switch (_context3.prev = _context3.next) {
                              case 0:
                                formValue = _args3.length > 0 && void 0 !== _args3[0] ? _args3[0] : {};
                                params = this.UDBParams;
                                _context3.next = 4;
                              ...
                              case 4:
                                _yield$verifyUniversa = _context3.sent;
                                stoken = _yield$verifyUniversa.stoken;
                                data = _yield$verifyUniversa.data;
                                reset_password_get(reset_password_getPrototypeOf(ResetPassword.prototype), "updateToken", this).call(this, params, {
                                    stoken,
                                    oauthToken: data && data.oauthToken
                                });
                                this.verifyAccountSuccess(reset_password_get(reset_password_getPrototypeOf(ResetPassword.prototype), "formatterMask", this).call(this, params));
                ...
                key: "verifyAccountSuccess",
                value: function() {
                    var mode = this.query.mode;
                    if (!mode) reportVerifyAccountSuccess();
                }
            }, {
                key: "initChangeAccountForm",
                value: function() {
                    this.$tips.hide();
                    $("#".concat(this.formId, "-verify")).hide();
                    $("#".concat(this.formId, "-reset")).show();
                    this.account = new reset_password_password({
                        id: "".concat(this.formId, "-reset"),
                        form: this
                    });
                }
            } ]);
