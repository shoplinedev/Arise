(() => {
    ...
    (() => {
        ...
        const changeAccountPassword = params => request_udbRequest.get("/udb/aq/pwd/change/modify.do", {
            params
        });
        ...
        const reportChangePasswordToUserCenter = () => reports_reportV2({
            page: report_pageMap.PasswordReset,
            module: report_Module.normal,
            component: 101,
            action_type: report_ActionType.click,
            event_id: 1617
        ...
        class PasswordSet extends base {
            constructor({id, form}) {
                super({
                    id,
        ...
        const reset_password_password = PasswordSet;
        ...
        class ResetPassword extends customer {
            ...
            init() {
                ...
                this.initForm();
                __SL_$__(`#${this.formId} .customer__footer-link .customer--link`).click((() => reportChangePasswordToUserCenter()));
            }
            initForm() {
            ...
            verifyAccountSuccess() {
                const {mode} = this.query;
                if (!mode) reportVerifyAccountSuccess();
            }
            initChangeAccountForm() {
                this.$tips.hide();
                __SL_$__(`#${this.formId}-verify`).hide();
                __SL_$__(`#${this.formId}-reset`).show();
                this.account = new reset_password_password({
        ...
        __SL_$__((function() {
            if (!document.getElementById("reset-password")) return false;
            new reset_password({
                id: "reset-password"
            });
        }));
