(() => {
    ...
    (() => {
        ...
        var PayStatusI18n = (_PayStatusI18n = {}, constants_defineProperty(_PayStatusI18n, EnumPayStatus.WAIT_PAY, t("order.pay-status.unpaid")), 
        constants_defineProperty(_PayStatusI18n, EnumPayStatus.WAIT_PAY_CALLBACK, t("order.pay-status.unpaid")), 
        constants_defineProperty(_PayStatusI18n, EnumPayStatus.PENDING, t("order.pay-status.paying")), 
        constants_defineProperty(_PayStatusI18n, EnumPayStatus.AUTHORIZED, t("order.pay-status.authorized")), 
        constants_defineProperty(_PayStatusI18n, EnumPayStatus.PARTIAL_PAYMENT, t("order.pay-status.partial-payment")), 
        constants_defineProperty(_PayStatusI18n, EnumPayStatus.PAYED, t("order.pay-status.already-paid")), 
        _PayStatusI18n);
        var DeliveryStatusI18n = (_DeliveryStatusI18n = {}, constants_defineProperty(_DeliveryStatusI18n, EnumDeliveryStatus.IN_STOCK, t("order.delivery-statusType.stocking")), 
        constants_defineProperty(_DeliveryStatusI18n, EnumDeliveryStatus.DELIVERY_PARTIAL, t("order.delivery-statusType.delivery-partial")), 
        constants_defineProperty(_DeliveryStatusI18n, EnumDeliveryStatus.SHIPPED, t("order.delivery-statusType.shipped")), 
        _DeliveryStatusI18n);
        function initCurrencyChangeListener(selector) {
            var cartRootNode = $(selector || document);
        ...
        var CustomerOrderList = function() {
            ...
            list_createClass(CustomerOrderList, [ {
                ...
                key: "formatTime",
                value: function() {
                    var dateEles = $(listContainerCls).find("[data-date-format]");
                    dateEles.each((function() {
                        var _$$data = $(this).data(), date = _$$data.date, dateFormat = _$$data.dateFormat;
                                    ...
                                    return regeneratorRuntime.wrap((function(_context) {
                                        while (1) switch (_context.prev = _context.next) {
                                          ...
                                          case 10:
                                            ...
                                            $("".concat(listContainerCls, " .main-wrapper")).append(result);
