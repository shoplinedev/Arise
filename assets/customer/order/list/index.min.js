(() => {
    ...
    (() => {
        ...
        var toDefault = SL_State.get("currencyCode") || storeCurrency;
        var currencyDetailList = window.Shopline.currencyConfig.currencyDetailList;
        (0, lib.setCurrencyConfig)(currencyDetailList);
        (0, lib.setStoreCurrency)(storeCurrency);
        (0, lib.setDefaultToCurrency)(toDefault);
        SL_State.on("currencyCode", (function(code) {
            (0, lib.setDefaultToCurrency)(code);
        }));
        var setDefault = function() {
            var toDefault = SL_State.get("currencyCode") || SL_State.get("storeInfo.currency");
            (0, lib.setDefaultToCurrency)(toDefault);
        };
        var convertFormat = function() {
            setDefault();
            return lib.convertFormat.apply(void 0, arguments);
        };
        ...
        function isDebugMode() {
            var value = env_get(envConst.DEBUG);
        ...
        var transports = [ lib_index_es["default"] ];
        if (env.appEnvInDevelop()) transports.unshift(index_es.consoleTransport);
        var baseLogger = index_es["default"].pipeTransport.apply(index_es["default"], transports);
