(() => {
    var __webpack_modules__ = {
        ...
        "../shared/browser/node_modules/copy-to-clipboard/index.js": (module, __unused_webpack_exports, __webpack_require__) => {
            "use strict";
            var deselectCurrent = __webpack_require__("../shared/browser/node_modules/toggle-selection/index.js");
        ...
        "../shared/browser/node_modules/toggle-selection/index.js": module => {
    ...
    (() => {
        ...
        var copy_to_clipboard = __webpack_require__("../shared/browser/node_modules/copy-to-clipboard/index.js");
        ...
        const checkAccountState = params => request_request.get("/user/front/userinfo/checkAccountState", {
            params
        });
        const getEmailCustomConfig = params => request_request.get("/user/front/email/getEmailCustomConfig", {
            params
        });
        const addCart = params => request_request.get("/user/front/user/center/addCart", {
            params
        });
        ...
        class ActivateAccount extends customer {
            constructor({id}) {
                ...
                this.applyed = false;
                this.$container = __SL_$__(`#${this.formId}`);
                this.$form = __SL_$__(`#${this.formId} .customer__form`);
                this.$title = __SL_$__(`#${this.formId} .customer__title`);
                this.$activateCode = __SL_$__(`#${this.formId} .activate-code`);
                this.$applyCodeBtn = __SL_$__(`#${this.formId} .apply-activate-code`);
                this.$copyCodeBtn = __SL_$__(`#${this.formId} .activate-copy`);
                this.$discountCode = __SL_$__(`#${this.formId} .customer-activate__discount`);
            ...
            getEmailCustomConfig() {
                getEmailCustomConfig({
                    ...
                    } else this.$title.text(t("customer.activate.normal_title"));
            ...
            onSuccess() {
                if (this.discountCode) this.showCode(); else redirectPage(USER_CENTER);
            }
            showCode() {
                ...
                this.$applyCodeBtn.removeClass("hide").on("click", (() => {
                    if (!this.applyed) {
                        ...
                        window.Shopline.event.emit("Cart::GetCartId", {
                            onSuccess: res => {
                                if (res.success || "SUCCESS" === res.code) addCart({
                                ...
                                })); else this.$applyCodeBtn.removeClass("btn--loading");
                            },
                            onError: () => {
                                this.$applyCodeBtn.removeClass("btn--loading");
                            }
                ...
                this.$copyCodeBtn.show().on("click", (() => {
                    copy_to_clipboard_default()(this.discountCode);
