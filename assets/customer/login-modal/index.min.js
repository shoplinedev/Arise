        ...
        var Register = function(_Customer) {
            ...
            sign_up_createClass(Register, [ {
                ...
                value: function() {
                    ...
                    __SL_$__("#".concat(this.formId, " .sign-up__footer-link .sign-up__link")).click((function(e) {
                        e.preventDefault();
                        _this4.$$reports.reportRegisterToLogin && _this4.$$reports.reportRegisterToLogin();
                        var href = __SL_$__(e.currentTarget).attr("href");
                ...
                value: function(transform) {
                    var excludeFields = [ "email", "phone", "username", "verifycode", "password" ];
                    return __SL_$__("#".concat(this.formId, " form")).serializeArray().filter((function(item) {
                        return !excludeFields.includes(item.name);
                ...
                value: function(data) {
                    ...
                    if (!checkResult) {
                        _get(_getPrototypeOf(Register.prototype), "setError", this).call(this, {
                    ...
                    var extInfo = this.getExtInfo({
                        gender: function(val) {
                            return val && parseInt(val, 10) || 0;
                        },
                        birthday: function(date) {
                            return date && dayjs_min_default()(date).format("YYYYMMDD") || "";
                        }
                    });
                    if (window && window.SLMemberPlugin && window.SLMemberPlugin.memberReferralCode && window.SLMemberPlugin.memberReferralCode.value) extInfo.memberReferralCode = window && window.SLMemberPlugin && window.SLMemberPlugin.memberReferralCode && window.SLMemberPlugin.memberReferralCode.value;
                    if (Object.keys(extInfo).length > 0) payload.extinfo = JSON.stringify(extInfo);
                    ...
                    return checkAccount(_get(_getPrototypeOf(Register.prototype), "formatRequestBody", this).call(this, sign_up_objectSpread(sign_up_objectSpread({}, params), {}, {
                        acct: payload.acct
                    }))).then((function(_ref3) {
                        var stoken = _ref3.stoken;
                        _get(_getPrototypeOf(Register.prototype), "updateToken", _this5).call(_this5, params, {
                            stoken
                        });
                ...
                value: function(_ref4) {
                    ...
                    return signUpMember(_get(_getPrototypeOf(Register.prototype), "formatRequestBody", this).call(this, sign_up_objectSpread(sign_up_objectSpread({}, payload), params))).then((function(_ref5) {
                ...
                key: "onSignUpSuccess",
                value: function(_ref6, data, mode) {
                    var _this7 = this;
                    var osudb_uid = _ref6.osudb_uid;
                ...
                key: "sendVerifyCode",
                value: function() {
                    var _sendVerifyCode = _asyncToGenerator(regeneratorRuntime.mark((function _callee4() {
                        var _this8 = this;
                              ...
                              case 4:
                                ...
                                return wrapArmorCaptcha({
                                    beforeSendCode: function() {
                                        var _beforeSendCode = _asyncToGenerator(regeneratorRuntime.mark((function _callee() {
                                            ...
                                            return regeneratorRuntime.wrap((function(_context) {
                                                while (1) switch (_context.prev = _context.next) {
                                                  case 0:
                                                    ...
                                                    acct = formValue[mode];
                                                    _context.next = 4;
                                                    return checkAccount(_get(_getPrototypeOf(Register.prototype), "formatRequestBody", _this8).call(_this8, sign_up_objectSpread(sign_up_objectSpread({}, UDBParams), {}, {
                                                        acct
                                                    })));
                                                  ...
                                                  case 4:
                                                    ...
                                                    _get(_getPrototypeOf(Register.prototype), "updateToken", _this8).call(_this8, UDBParams, {
                                                        stoken
                                                    });
                                    ...
                                    onSendCode: function() {
                                        var _onSendCode = _asyncToGenerator(regeneratorRuntime.mark((function _callee2(captchaToken) {
                                            ...
                                            return regeneratorRuntime.wrap((function(_context2) {
                                                while (1) switch (_context2.prev = _context2.next) {
                                                  case 0:
                                                    ...
                                                    acct = formValue[mode];
                                                    _context2.next = 4;
                                                    return sendSignUpVerificationCode(_get(_getPrototypeOf(Register.prototype), "formatRequestBody", _this8).call(_this8, sign_up_objectSpread(sign_up_objectSpread({
                                                        acct
                                                    }, UDBParams), {}, {
                                    ...
                                    onCaptchaVerifySuccess: function() {
                                        var _onCaptchaVerifySuccess = _asyncToGenerator(regeneratorRuntime.mark((function _callee3() {
                ...
                value: function(e) {
                    ...
                    _get(_getPrototypeOf(Register.prototype), "setError", this).call(this, e);
                }
            }, {
                key: "reportSignUp",
