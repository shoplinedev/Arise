(() => {
    ...
    (() => {
        ...
        function state_selector_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function state_selector_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function state_selector_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) state_selector_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) state_selector_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        var SLState = function() {
            function SLState(state) {
                state_selector_classCallCheck(this, SLState);
                this.bus = new SL_EventEmitter;
                this.rootState = state;
            }
            state_selector_createClass(SLState, [ {
                key: "get",
                value: function(path) {
        ...
        var state_selector_window = window;
        state_selector_window.SL_State;
        ...
        var ModalWithHtml = function(_Base) {
            ...
            function ModalWithHtml() {
                ...
                _this.modalId = config.id || "".concat(common_DEFAULT_MODAL_ID_PRE).concat(++uuid);
        ...
        var Register = function(_Customer) {
            ...
            sign_up_createClass(Register, [ {
                ...
                value: function(data) {
                    ...
                    if (!checkResult) {
                        _get(sign_up_getPrototypeOf(Register.prototype), "setError", this).call(this, {
                    ...
                    return checkAccount(_get(sign_up_getPrototypeOf(Register.prototype), "formatRequestBody", this).call(this, biz_sign_up_objectSpread(biz_sign_up_objectSpread({}, params), {}, {
                        acct: payload.acct
                    }))).then((function(_ref3) {
                        var stoken = _ref3.stoken;
                        _get(sign_up_getPrototypeOf(Register.prototype), "updateToken", _this5).call(_this5, params, {
                            stoken
                        });
                ...
                value: function(_ref4) {
                    ...
                    return signUpMember(_get(sign_up_getPrototypeOf(Register.prototype), "formatRequestBody", this).call(this, biz_sign_up_objectSpread(biz_sign_up_objectSpread({}, payload), params))).then((function(_ref5) {
                                            ...
                                            return regeneratorRuntime.wrap((function(_context) {
                                                while (1) switch (_context.prev = _context.next) {
                                                  case 0:
                                                    ...
                                                    acct = formValue[mode];
                                                    _context.next = 4;
                                                    return checkAccount(_get(sign_up_getPrototypeOf(Register.prototype), "formatRequestBody", _this8).call(_this8, biz_sign_up_objectSpread(biz_sign_up_objectSpread({}, UDBParams), {}, {
                                                        acct
                                                    })));
                                                  ...
                                                  case 4:
                                                    ...
                                                    _get(sign_up_getPrototypeOf(Register.prototype), "updateToken", _this8).call(_this8, UDBParams, {
                                                        stoken
                                                    });
                                            ...
                                            return regeneratorRuntime.wrap((function(_context2) {
                                                while (1) switch (_context2.prev = _context2.next) {
                                                  case 0:
                                                    ...
                                                    acct = formValue[mode];
                                                    _context2.next = 4;
                                                    return sendSignUpVerificationCode(_get(sign_up_getPrototypeOf(Register.prototype), "formatRequestBody", _this8).call(_this8, biz_sign_up_objectSpread(biz_sign_up_objectSpread({
                                                        acct
                                                    }, UDBParams), {}, {
                ...
                value: function(e) {
                    ...
                    _get(sign_up_getPrototypeOf(Register.prototype), "setError", this).call(this, e);
                }
            }, {
                key: "reportSignUp",
