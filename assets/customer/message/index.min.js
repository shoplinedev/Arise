(() => {
    var __webpack_modules__ = {
        "../shared/browser/node_modules/@yy/sl-http-upload/dist/index.js": (module, exports, __webpack_require__) => {
            "use strict";
            var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
            __webpack_require__("../shared/browser/node_modules/core-js/modules/es.global-this.js");
            ...
            (function(global, factory) {
                "object" === (false ? 0 : _typeof(exports)) && "object" !== "undefined" ? factory(exports) : true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ exports ], 
                                  ...
                                  case 8:
                                    if (200 === (null === res || void 0 === res ? void 0 : res.status)) {
                                        null === (_b = null === response || void 0 === response ? void 0 : response.data) || void 0 === _b ? void 0 : _b.forEach((function(item, index) {
                                            _this.ossDatas.add(_assign({}, item));
                                        }));
        ...
        "../shared/browser/node_modules/core-js/internals/array-buffer-basic-detection.js": module => {
        ...
        "../shared/browser/node_modules/core-js/internals/array-buffer-view-core.js": (module, __unused_webpack_exports, __webpack_require__) => {
            "use strict";
            var NATIVE_ARRAY_BUFFER = __webpack_require__("../shared/browser/node_modules/core-js/internals/array-buffer-basic-detection.js");
        ...
        "../shared/browser/node_modules/core-js/internals/array-buffer.js": (module, __unused_webpack_exports, __webpack_require__) => {
            ...
            if (!NATIVE_ARRAY_BUFFER) {
                ...
                if (!fails((function() {
                    ...
                    return 1 != NativeArrayBuffer.length || INCORRECT_ARRAY_BUFFER_NAME && !CONFIGURABLE_FUNCTION_NAME;
                }))) {
                    $ArrayBuffer = function(length) {
                        anInstance(this, ArrayBufferPrototype);
        ...
        "../shared/browser/node_modules/core-js/internals/define-built-in-accessor.js": (module, __unused_webpack_exports, __webpack_require__) => {
            var makeBuiltIn = __webpack_require__("../shared/browser/node_modules/core-js/internals/make-built-in.js");
            var defineProperty = __webpack_require__("../shared/browser/node_modules/core-js/internals/object-define-property.js");
        ...
        "../shared/browser/node_modules/core-js/internals/ieee754.js": module => {
            var $Array = Array;
            var abs = Math.abs;
            var pow = Math.pow;
            var floor = Math.floor;
        ...
        "../shared/browser/node_modules/core-js/internals/url-constructor-detection.js": (module, __unused_webpack_exports, __webpack_require__) => {
            var fails = __webpack_require__("../shared/browser/node_modules/core-js/internals/fails.js");
            var wellKnownSymbol = __webpack_require__("../shared/browser/node_modules/core-js/internals/well-known-symbol.js");
            var IS_PURE = __webpack_require__("../shared/browser/node_modules/core-js/internals/is-pure.js");
            var ITERATOR = wellKnownSymbol("iterator");
        ...
        "../shared/browser/node_modules/core-js/modules/es.global-this.js": (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
            var $ = __webpack_require__("../shared/browser/node_modules/core-js/internals/export.js");
            var global = __webpack_require__("../shared/browser/node_modules/core-js/internals/global.js");
            $({
                global: true
        ...
        "../shared/browser/node_modules/core-js/modules/web.url-search-params.constructor.js": (module, __unused_webpack_exports, __webpack_require__) => {
            "use strict";
            __webpack_require__("../shared/browser/node_modules/core-js/modules/es.array.iterator.js");
            var $ = __webpack_require__("../shared/browser/node_modules/core-js/internals/export.js");
            var global = __webpack_require__("../shared/browser/node_modules/core-js/internals/global.js");
            ...
            var uncurryThis = __webpack_require__("../shared/browser/node_modules/core-js/internals/function-uncurry-this.js");
            var DESCRIPTORS = __webpack_require__("../shared/browser/node_modules/core-js/internals/descriptors.js");
            var USE_NATIVE_URL = __webpack_require__("../shared/browser/node_modules/core-js/internals/url-constructor-detection.js");
            var defineBuiltIn = __webpack_require__("../shared/browser/node_modules/core-js/internals/define-built-in.js");
            var defineBuiltIns = __webpack_require__("../shared/browser/node_modules/core-js/internals/define-built-ins.js");
            var setToStringTag = __webpack_require__("../shared/browser/node_modules/core-js/internals/set-to-string-tag.js");
            var createIteratorConstructor = __webpack_require__("../shared/browser/node_modules/core-js/internals/iterator-create-constructor.js");
            ...
            defineBuiltIn(URLSearchParamsPrototype, "toString", (function() {
        ...
        "../shared/browser/node_modules/core-js/modules/web.url.constructor.js": (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
            "use strict";
            __webpack_require__("../shared/browser/node_modules/core-js/modules/es.string.iterator.js");
            var $ = __webpack_require__("../shared/browser/node_modules/core-js/internals/export.js");
            var DESCRIPTORS = __webpack_require__("../shared/browser/node_modules/core-js/internals/descriptors.js");
            ...
            var uncurryThis = __webpack_require__("../shared/browser/node_modules/core-js/internals/function-uncurry-this.js");
            var defineBuiltIn = __webpack_require__("../shared/browser/node_modules/core-js/internals/define-built-in.js");
            var defineBuiltInAccessor = __webpack_require__("../shared/browser/node_modules/core-js/internals/define-built-in-accessor.js");
            var anInstance = __webpack_require__("../shared/browser/node_modules/core-js/internals/an-instance.js");
            var hasOwn = __webpack_require__("../shared/browser/node_modules/core-js/internals/has-own-property.js");
            var assign = __webpack_require__("../shared/browser/node_modules/core-js/internals/object-assign.js");
            ...
            var setToStringTag = __webpack_require__("../shared/browser/node_modules/core-js/internals/set-to-string-tag.js");
            var validateArgumentsLength = __webpack_require__("../shared/browser/node_modules/core-js/internals/validate-arguments-length.js");
            var URLSearchParamsModule = __webpack_require__("../shared/browser/node_modules/core-js/modules/web.url-search-params.constructor.js");
            var InternalStateModule = __webpack_require__("../shared/browser/node_modules/core-js/internals/internal-state.js");
            var setInternalState = InternalStateModule.set;
        ...
        "../shared/browser/node_modules/core-js/modules/web.url.js": (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
            __webpack_require__("../shared/browser/node_modules/core-js/modules/web.url.constructor.js");
        },
    ...
    (() => {
        ...
        var PreviewImage = function() {
            function PreviewImage(_ref) {
                ...
                this.id = id;
                this.$modal = __SL_$__("#".concat(this.id));
            ...
            message_list_createClass(MessageList, [ {
                ...
                value: function() {
                    ...
                    this.$container.on("click", ".msg-image", (function(e) {
                        var src = __SL_$__(e.currentTarget).find("img").attr("src");
        ...
        var Upload = function() {
            function Upload(_ref) {
                ...
                this.$input = __SL_$__("#".concat(this.id)).find('input[type="file"]');
                this.$loading = __SL_$__("#".concat(this.id)).find(".sl-upload__loading");
                this.$picIcon = __SL_$__("#".concat(this.id)).find(".sl-upload__input");
                this.init();
            }
