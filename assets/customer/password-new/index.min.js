(() => {
    ...
    (() => {
        ...
        var resetPasswordByToken = function(params) {
            return request_udbRequest.get("/udb/aq/pwd/retrieve/token/modify.do", {
                params
            });
        };
        ...
        var captcha_modal_CAPTCHA_CODE = [ "2019", "2020", "3018", "3021", "1015", "2015" ];
        var wrapArmorCaptcha = function() {
            var _ref4 = _asyncToGenerator(regeneratorRuntime.mark((function _callee3(_ref3) {
                var beforeCapture, onCaptureCaptcha, onCaptchaVerifySuccess, onError;
                return regeneratorRuntime.wrap((function(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        beforeCapture = _ref3.beforeCapture, onCaptureCaptcha = _ref3.onCaptureCaptcha, 
                        onCaptchaVerifySuccess = _ref3.onCaptchaVerifySuccess, onError = _ref3.onError;
                        if (captchaToken) {
                            _context3.next = 6;
                            break;
                        }
                        _context3.t0 = isFunction(beforeCapture);
                        if (!_context3.t0) {
                            _context3.next = 6;
                            break;
                        }
                      ...
                      case 6:
                        _context3.prev = 6;
                        _context3.t1 = isFunction(onCaptureCaptcha);
                        if (!_context3.t1) {
                            _context3.next = 11;
                            break;
                        }
                        _context3.next = 11;
                        return onCaptureCaptcha(captchaToken);
                                    ...
                                    return regeneratorRuntime.wrap((function(_context2) {
                                        while (1) switch (_context2.prev = _context2.next) {
                                          case 0:
                                            ...
                                            _context2.next = 6;
                                            return onCaptchaVerifySuccess(token, _context3.t2 || {});
        ...
        const getUdbInfo = function(_ref3) {
            ...
            var type = params.type, appid = params.appid, subappid = params.subappid, mode = params.mode, token = params.token;
        ...
        var PasswordNew = function(_Customer) {
            ...
            password_verify_createClass(PasswordNew, [ {
                ...
                value: function() {
                    ...
                    __SL_$__("#".concat(this.containerId, " .password__buttons a")).click((function() {
                        var display = __SL_$__("#".concat(_this2.formId)).css("display");
                              ...
                              case 4:
                                ...
                                return wrapArmorCaptcha({
                                    beforeCapture: function() {
                                        var _beforeCapture = password_verify_asyncToGenerator(regeneratorRuntime.mark((function _callee() {
                                        ...
                                        function beforeCapture() {
                                            return _beforeCapture.apply(this, arguments);
                                        }
                                        return beforeCapture;
                                    }(),
                                    onCaptureCaptcha: function() {
                                        var _onCaptureCaptcha = password_verify_asyncToGenerator(regeneratorRuntime.mark((function _callee2(captchaToken) {
                                        ...
                                        function onCaptureCaptcha(_x) {
                                            return _onCaptureCaptcha.apply(this, arguments);
                                        }
                                        return onCaptureCaptcha;
                                    }(),
                ...
                value: function() {
                    var _this5 = this;
                    __SL_$__("#".concat(this.formId)).hide();
                    ...
                    __SL_$__("#".concat(this.containerId)).find(".password-reset-tips").text(t("customer.forget_password.tips_reset_password", {
                        account: this.formatterMask(this.UDBParams)
                    }));
                    __SL_$__("#".concat(passwordSetForm.formId)).show();
                }
            }, {
                key: "onResetConfirm",
                value: function(data) {
        ...
        function password_token_typeof(obj) {
            "@babel/helpers - typeof";
            if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) password_token_typeof = function(obj) {
                return typeof obj;
            }; else password_token_typeof = function(obj) {
                return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
            };
            return password_token_typeof(obj);
        }
        function password_token_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function password_token_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) password_token_ownKeys(Object(source), true).forEach((function(key) {
                    password_token_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else password_token_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function password_token_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function password_token_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function password_token_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function password_token_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) password_token_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) password_token_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        function password_token_inherits(subClass, superClass) {
            if ("function" !== typeof superClass && null !== superClass) throw new TypeError("Super expression must either be null or a function");
            subClass.prototype = Object.create(superClass && superClass.prototype, {
                constructor: {
                    value: subClass,
            ...
            if (superClass) password_token_setPrototypeOf(subClass, superClass);
        }
        function password_token_setPrototypeOf(o, p) {
            password_token_setPrototypeOf = Object.setPrototypeOf || function(o, p) {
                o.__proto__ = p;
                return o;
            };
            return password_token_setPrototypeOf(o, p);
        }
        function password_token_createSuper(Derived) {
            var hasNativeReflectConstruct = password_token_isNativeReflectConstruct();
            return function() {
                var result, Super = password_token_getPrototypeOf(Derived);
                if (hasNativeReflectConstruct) {
                    var NewTarget = password_token_getPrototypeOf(this).constructor;
                    result = Reflect.construct(Super, arguments, NewTarget);
                } else result = Super.apply(this, arguments);
                return password_token_possibleConstructorReturn(this, result);
            };
        }
        function password_token_possibleConstructorReturn(self, call) {
            if (call && ("object" === password_token_typeof(call) || "function" === typeof call)) return call;
            return password_token_assertThisInitialized(self);
        }
        function password_token_assertThisInitialized(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }
        function password_token_isNativeReflectConstruct() {
            if ("undefined" === typeof Reflect || !Reflect.construct) return false;
            if (Reflect.construct.sham) return false;
            if ("function" === typeof Proxy) return true;
            try {
        ...
        function password_token_getPrototypeOf(o) {
            password_token_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
                return o.__proto__ || Object.getPrototypeOf(o);
            };
            return password_token_getPrototypeOf(o);
        }
        var PasswordToken = function(_Customer) {
            password_token_inherits(PasswordToken, _Customer);
            var _super = password_token_createSuper(PasswordToken);
            function PasswordToken(_ref) {
                var _this;
                var id = _ref.id, containerId = _ref.containerId, setFormId = _ref.setFormId;
                password_token_classCallCheck(this, PasswordToken);
                _this = _super.call(this, {
                    id,
                ...
                _this.containerId = containerId;
                _this.setFormId = setFormId;
                _this.setInstance = null;
                return _this;
            }
            password_token_createClass(PasswordToken, [ {
                key: "onResetConfirm",
                value: function(data) {
                    return resetPasswordByToken(password_token_objectSpread(password_token_objectSpread({}, this.UDBParams), {}, {
                        pwd: data.password
                    })).then((function() {
                ...
                value: function() {
                    ...
                    this.setInstance = new password_set({
                        id: this.setFormId,
                        onSubmit: function(data) {
                            if ("preview" === _this2.query.token) return Promise.resolve();
                            return _this2.onResetConfirm(data);
                        }
                    });
                    __SL_$__("#".concat(this.containerId)).find(".password-reset-tips").text(t("customer.forget_password.tips_reset_password", {
