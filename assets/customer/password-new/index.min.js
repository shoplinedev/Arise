(() => {
    ...
    (() => {
        ...
        var getRetrievePrechk = function(params) {
            return request_udbRequest.get("/udb/aq/pwd/retrieve/prechk.do", {
                params
            });
        };
        var getMethodList = function(params) {
            return request_udbRequest.get("/udb/aq/uni/getMethodList.do", {
                params
            });
        };
        var resetPassword = function(params) {
            return request_udbRequest.get("/udb/aq/pwd/retrieve/modify.do", {
                params
            });
        };
        ...
        var reportForgetPasswordToLogin = function() {
            reports_reportV2({
        ...
        var reportResetPasswordToLogin = function() {
            reports_reportV2({
                ...
                return regeneratorRuntime.wrap((function(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      ...
                      case 14:
                        ...
                        openCaptchaModal({
                            onSuccess: function() {
                                var _onSuccess2 = _asyncToGenerator(regeneratorRuntime.mark((function _callee2(token) {
        ...
        function password_set_typeof(obj) {
            "@babel/helpers - typeof";
            if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) password_set_typeof = function(obj) {
                return typeof obj;
            }; else password_set_typeof = function(obj) {
                return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
            };
            return password_set_typeof(obj);
        }
        function password_set_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function password_set_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function password_set_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) password_set_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) password_set_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        function password_set_inherits(subClass, superClass) {
            if ("function" !== typeof superClass && null !== superClass) throw new TypeError("Super expression must either be null or a function");
            subClass.prototype = Object.create(superClass && superClass.prototype, {
                constructor: {
                    value: subClass,
            ...
            if (superClass) password_set_setPrototypeOf(subClass, superClass);
        }
        function password_set_setPrototypeOf(o, p) {
            password_set_setPrototypeOf = Object.setPrototypeOf || function(o, p) {
                o.__proto__ = p;
                return o;
            };
            return password_set_setPrototypeOf(o, p);
        }
        function password_set_createSuper(Derived) {
            var hasNativeReflectConstruct = password_set_isNativeReflectConstruct();
            return function() {
                var result, Super = password_set_getPrototypeOf(Derived);
                if (hasNativeReflectConstruct) {
                    var NewTarget = password_set_getPrototypeOf(this).constructor;
                    result = Reflect.construct(Super, arguments, NewTarget);
                } else result = Super.apply(this, arguments);
                return password_set_possibleConstructorReturn(this, result);
            };
        }
        function password_set_possibleConstructorReturn(self, call) {
            if (call && ("object" === password_set_typeof(call) || "function" === typeof call)) return call;
            return password_set_assertThisInitialized(self);
        }
        function password_set_assertThisInitialized(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }
        function password_set_isNativeReflectConstruct() {
            if ("undefined" === typeof Reflect || !Reflect.construct) return false;
            if (Reflect.construct.sham) return false;
            if ("function" === typeof Proxy) return true;
            try {
        ...
        function password_set_getPrototypeOf(o) {
            password_set_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
                return o.__proto__ || Object.getPrototypeOf(o);
            };
            return password_set_getPrototypeOf(o);
        }
        var PasswordSet = function(_Customer) {
            password_set_inherits(PasswordSet, _Customer);
            var _super = password_set_createSuper(PasswordSet);
            function PasswordSet(_ref) {
                var _this;
                var id = _ref.id, onSubmit = _ref.onSubmit;
                password_set_classCallCheck(this, PasswordSet);
                _this = _super.call(this, {
                    id,
            ...
            password_set_createClass(PasswordSet, [ {
                key: "init",
                value: function() {
                    var _this2 = this;
                    this.passwordForm = new commons_form({
                        ...
                        onSubmit: function(data) {
                            return _this2.onSubmit(data).then((function(res) {
                                return Promise.resolve(res);
                            }))["catch"]((function(error) {
                                _this2.passwordForm && _this2.passwordForm.formInstance.setErrMsgIntoDom([ {
                                    name: "repeatPassword",
        ...
        function password_verify_typeof(obj) {
            "@babel/helpers - typeof";
            if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) password_verify_typeof = function(obj) {
                return typeof obj;
            }; else password_verify_typeof = function(obj) {
                return obj && "function" === typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
            };
            return password_verify_typeof(obj);
        }
        function password_verify_ownKeys(object, enumerableOnly) {
            var keys = Object.keys(object);
            if (Object.getOwnPropertySymbols) {
                var symbols = Object.getOwnPropertySymbols(object);
                if (enumerableOnly) symbols = symbols.filter((function(sym) {
        ...
        function password_verify_objectSpread(target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = null != arguments[i] ? arguments[i] : {};
                if (i % 2) password_verify_ownKeys(Object(source), true).forEach((function(key) {
                    password_verify_defineProperty(target, key, source[key]);
                })); else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); else password_verify_ownKeys(Object(source)).forEach((function(key) {
                    Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                }));
            }
            return target;
        }
        function password_verify_defineProperty(obj, key, value) {
            if (key in obj) Object.defineProperty(obj, key, {
                value,
                enumerable: true,
                configurable: true,
        ...
        function password_verify_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
            try {
                var info = gen[key](arg);
                var value = info.value;
            } catch (error) {
        ...
        function password_verify_asyncToGenerator(fn) {
            return function() {
                var self = this, args = arguments;
                return new Promise((function(resolve, reject) {
                    var gen = fn.apply(self, args);
                    function _next(value) {
                        password_verify_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);
                    }
                    function _throw(err) {
                        password_verify_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);
                    }
                    _next(void 0);
                }));
            };
        }
        function password_verify_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function password_verify_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function password_verify_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) password_verify_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) password_verify_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        ...
        function _superPropBase(object, property) {
            while (!Object.prototype.hasOwnProperty.call(object, property)) {
                object = password_verify_getPrototypeOf(object);
                if (null === object) break;
            }
            return object;
        }
        function password_verify_inherits(subClass, superClass) {
            if ("function" !== typeof superClass && null !== superClass) throw new TypeError("Super expression must either be null or a function");
            subClass.prototype = Object.create(superClass && superClass.prototype, {
                constructor: {
                    value: subClass,
            ...
            if (superClass) password_verify_setPrototypeOf(subClass, superClass);
        }
        function password_verify_setPrototypeOf(o, p) {
            password_verify_setPrototypeOf = Object.setPrototypeOf || function(o, p) {
                o.__proto__ = p;
                return o;
            };
            return password_verify_setPrototypeOf(o, p);
        }
        function password_verify_createSuper(Derived) {
            var hasNativeReflectConstruct = password_verify_isNativeReflectConstruct();
            return function() {
                var result, Super = password_verify_getPrototypeOf(Derived);
                if (hasNativeReflectConstruct) {
                    var NewTarget = password_verify_getPrototypeOf(this).constructor;
                    result = Reflect.construct(Super, arguments, NewTarget);
                } else result = Super.apply(this, arguments);
                return password_verify_possibleConstructorReturn(this, result);
            };
        }
        function password_verify_possibleConstructorReturn(self, call) {
            if (call && ("object" === password_verify_typeof(call) || "function" === typeof call)) return call;
            return password_verify_assertThisInitialized(self);
        }
        function password_verify_assertThisInitialized(self) {
            if (void 0 === self) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return self;
        }
        function password_verify_isNativeReflectConstruct() {
            if ("undefined" === typeof Reflect || !Reflect.construct) return false;
            if (Reflect.construct.sham) return false;
            if ("function" === typeof Proxy) return true;
            try {
        ...
        function password_verify_getPrototypeOf(o) {
            password_verify_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function(o) {
                return o.__proto__ || Object.getPrototypeOf(o);
            };
            return password_verify_getPrototypeOf(o);
        }
        var PasswordNew = function(_Customer) {
            password_verify_inherits(PasswordNew, _Customer);
            var _super = password_verify_createSuper(PasswordNew);
            function PasswordNew(_ref) {
                var _this;
                var id = _ref.id, containerId = _ref.containerId, setFormId = _ref.setFormId;
                password_verify_classCallCheck(this, PasswordNew);
                _this = _super.call(this, {
                    id,
                    formType: "passwordNew"
                });
                _this.containerId = containerId;
                _this.setFormId = setFormId;
                _this.passwordForm = null;
                return _this;
            }
            password_verify_createClass(PasswordNew, [ {
                key: "init",
                value: function() {
                    var _this2 = this;
                    this.passwordForm = new commons_form({
                    ...
                    $("#".concat(this.containerId, " .password__buttons a")).click((function() {
                        var display = $("#".concat(_this2.formId)).css("display");
                ...
                key: "sendVerifyCode",
                value: function() {
                    var _sendVerifyCode = password_verify_asyncToGenerator(regeneratorRuntime.mark((function _callee4() {
                        var _this4 = this;
                        var mode, UDBParams, formValue, account;
                        return regeneratorRuntime.wrap((function(_context4) {
                            while (1) switch (_context4.prev = _context4.next) {
                              ...
                              case 4:
                                formValue = this.passwordForm && this.passwordForm.getFormValue();
                                account = formValue[mode];
                                _context4.next = 8;
                                return wrapArmorCaptcha({
                                    beforeSendCode: function() {
                                        var _beforeSendCode = password_verify_asyncToGenerator(regeneratorRuntime.mark((function _callee() {
                                            var _yield$getRetrievePre, stoken, data, _yield$getMethodList, methods, newStoken, _ref2, method, mobileMask, emailMask;
                                            return regeneratorRuntime.wrap((function(_context) {
                                                while (1) switch (_context.prev = _context.next) {
                                                  case 0:
                                                    _context.next = 2;
                                                    return getRetrievePrechk(_get(password_verify_getPrototypeOf(PasswordNew.prototype), "formatRequestBody", _this4).call(_this4, password_verify_objectSpread(password_verify_objectSpread({}, UDBParams), {}, {
                                                        account
                                                    })));

                                                  case 2:
                                                    _yield$getRetrievePre = _context.sent;
                                                    stoken = _yield$getRetrievePre.stoken;
                                                    data = _yield$getRetrievePre.data;
                                                    _get(password_verify_getPrototypeOf(PasswordNew.prototype), "updateToken", _this4).call(_this4, UDBParams, {
                                                        stoken,
                                                        servcode: data && data.servcode
                                                    });
                                                    _context.next = 8;
                                                    return getMethodList(_get(password_verify_getPrototypeOf(PasswordNew.prototype), "formatRequestBody", _this4).call(_this4, UDBParams));
                                    ...
                                    onSendCode: function() {
                                        var _onSendCode = password_verify_asyncToGenerator(regeneratorRuntime.mark((function _callee2(captchaToken) {
                                            var sendCodeFn, _yield$sendCodeFn, lastStoken;
                                            return regeneratorRuntime.wrap((function(_context2) {
                                                while (1) switch (_context2.prev = _context2.next) {
                                                  case 0:
                                                    sendCodeFn = UDBParams._method && UDBParams._method.includes("sms") ? sendPhoneVerificationCode : sendEmailVerificationCode;
                                                    _context2.next = 3;
                                                    return sendCodeFn(_get(password_verify_getPrototypeOf(PasswordNew.prototype), "formatRequestBody", _this4).call(_this4, password_verify_objectSpread(password_verify_objectSpread({}, UDBParams), {}, {
                                                        captcha: captchaToken
                                                    })));

                                                  case 3:
                                                    _yield$sendCodeFn = _context2.sent;
                                                    lastStoken = _yield$sendCodeFn.stoken;
                                                    _get(password_verify_getPrototypeOf(PasswordNew.prototype), "updateToken", _this4).call(_this4, UDBParams, {
                                                        stoken: lastStoken
                                                    });
                                    ...
                                    onCaptchaVerifySuccess: function() {
                                        var _onCaptchaVerifySuccess = password_verify_asyncToGenerator(regeneratorRuntime.mark((function _callee3() {
                                            return regeneratorRuntime.wrap((function(_context3) {
                                                while (1) switch (_context3.prev = _context3.next) {
                                                  case 0:
                                                    _this4.passwordForm.formItemInstances.verifycode.triggerSendCode();
                ...
                value: function() {
                    var _this5 = this;
                    $("#".concat(this.formId)).hide();
                    var passwordSetForm = new password_set({
                        id: this.setFormId,
                        onSubmit: function(data) {
                            return _this5.onResetConfirm(data);
                        }
                    });
                    $("#".concat(this.containerId)).find(".password-reset-tips").text(t("tips.reset-password", {
                        account: this.formatterMask(this.UDBParams)
                    }));
                    $("#".concat(passwordSetForm.formId)).show();
                }
            }, {
                key: "onResetConfirm",
                value: function(data) {
                    return resetPassword(_get(password_verify_getPrototypeOf(PasswordNew.prototype), "formatRequestBody", this).call(this, password_verify_objectSpread(password_verify_objectSpread({}, this.UDBParams), {}, {
                        pwd: data.password
                    }))).then((function() {
                        window.location.href = "".concat(SIGN_IN).concat(window.location.search);
                        return Promise.resolve();
                    }))["catch"]((function(error) {
                        return Promise.reject(error);
                    }));
                ...
                value: function() {
                    var _this6 = this;
                    var UDBParams = this.UDBParams;
                    var _ref3 = this.passwordForm && this.passwordForm.getFormValue(), verifycode = _ref3.verifycode;
                    if (UDBParams.stoken) {
                        var verifyCodeFn = UDBParams._method && UDBParams._method.includes("sms") ? verifyPhoneVerificationCode : verifyEmailVerificationCode;
                        return verifyCodeFn(_get(password_verify_getPrototypeOf(PasswordNew.prototype), "formatRequestBody", this).call(this, password_verify_objectSpread(password_verify_objectSpread({}, UDBParams), {}, {
                            code: verifycode
                        }))).then((function(_ref4) {
                            var stoken = _ref4.stoken, data = _ref4.data;
                            _get(password_verify_getPrototypeOf(PasswordNew.prototype), "updateToken", _this6).call(_this6, UDBParams, {
                                stoken,
                            ...
                            _this6.passwordForm && _this6.passwordForm.formInstance.setErrMsgIntoDom([ {
                                name: "verifycode",
                                messages: [ getUdbErrorMessage(error) ]
                            } ]);
                            return Promise.reject(error);
        ...
        function password_new_classCallCheck(instance, Constructor) {
            if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
        }
        function password_new_defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
                var descriptor = props[i];
                descriptor.enumerable = descriptor.enumerable || false;
                descriptor.configurable = true;
        ...
        function password_new_createClass(Constructor, protoProps, staticProps) {
            if (protoProps) password_new_defineProperties(Constructor.prototype, protoProps);
            if (staticProps) password_new_defineProperties(Constructor, staticProps);
            return Constructor;
        }
        var password_new_PasswordNew = function() {
            function PasswordNew(_ref) {
                var _ref$id = _ref.id, id = void 0 === _ref$id ? "customer-password" : _ref$id;
                password_new_classCallCheck(this, PasswordNew);
                this.id = "".concat(id, "-verify");
                this.containerId = id;
                this.setFormId = "".concat(id, "-set");
                this.verifyInstance = null;
                this.init();
            }
            password_new_createClass(PasswordNew, [ {
                key: "init",
                value: function() {
