    ...
    (() => {
        ...
        var ThirdPartLogin = function() {
            ...
            third_part_login_createClass(ThirdPartLogin, [ {
                ...
                value: function() {
                    var _this2 = this;
                    var storeRegisterConfig = SL_State && SL_State.get("shop.store_register_config");
                    ...
                    var _ref3 = SL_State && SL_State.get("customer_address"), _ref3$countryCode = _ref3.countryCode, countryCode = void 0 === _ref3$countryCode ? THIRD_DEFAULT_REGION : _ref3$countryCode;
