    ...
    (() => {
                        ...
                        return regeneratorRuntime.wrap((function(_context) {
                            while (1) switch (_context.prev = _context.next) {
                              ...
                              case 10:
                                ...
                                $container = __SL_$__(".customer-sign-in-container");
        ...
        var Login = function(_Customer) {
            ...
            sign_in_createClass(Login, [ {
                ...
                key: "showConfirmSubscribeTip",
                value: function() {
                    var from = (0, url.getUrlQuery)("from");
                    if (from === CONFIRM_SUBSCRIBE_EMAIL) {
                        var tips = t("customer.login.subscribe_confirm_tip");
                        __SL_$__("#".concat(this.formId, " .sign-in__from_confirm_email")).show().text(tips);
                    }
                }
            }, {
                key: "initForm",
                value: function() {
                    ...
                    if (storage.sessionStorage.get(ACCOUNT_ACTIVATED_TOKEN_EXPIRED)) {
                        __SL_$__("#".concat(this.formId, " .sign-in__has-registered")).show().text(t("customer.activate.token_expired"));
                        storage.sessionStorage.del(ACCOUNT_ACTIVATED_TOKEN_EXPIRED);
                    }
                    if (storage.sessionStorage.get(RESET_PASSWORD_TOKEN_EXPIRED)) {
                        __SL_$__("#".concat(this.formId, " .sign-in__has-registered")).show().text(t("customer.forget_password.token_expired"));
                    ...
                    if (formValue) {
                        ...
                        var tips = t("customer.general.error_message_".concat(isPhone ? MOBILE_REGISTERED : EMAIL_REGISTERED));
                        __SL_$__("#".concat(this.formId, " .sign-in__has-registered")).show().text(tips);
                        fields = fields.map((function(field) {
                            return biz_sign_in_objectSpread(biz_sign_in_objectSpread({}, field), {}, {
                                value: formValue[field.name]
                            });
                        }));
                        if ("email" === mode) __SL_$__("#".concat(this.formId, ' input[name="email"]')).val(formValue.email);
                ...
                value: function() {
                    var _this4 = this;
                    __SL_$__("#".concat(this.formId, " .sign-in__guest-button")).click((function() {
                        return redirectPage();
                    }));
                ...
                value: function() {
                    ...
                    __SL_$__("#".concat(this.formId, " .sign-in__buttons")).on("click", "a", (function(e) {
                        e.preventDefault();
                        var path = __SL_$__(e.currentTarget).attr("href");
                ...
                value: function(data) {
                    ...
                    var onLogin = function(captchaToken) {
                        var updateParams = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                        var formData = _this5.loginForm.getFormValue();
                        _this5.loginForm.setLoading(true);
                        return loginAccount(_get(sign_in_getPrototypeOf(Login.prototype), "formatRequestBody", _this5).call(_this5, biz_sign_in_objectSpread(biz_sign_in_objectSpread(biz_sign_in_objectSpread({}, payload), params), {}, {
                    ...
                    return wrapArmorCaptcha({
                        ...
                        onCaptchaVerifySuccess: function(captchaToken, prevRequestResult) {
                        ...
                        onError: function(e) {
                            _this5.setError(e);
                            _this5.loginForm.setLoading(false);
                        }
                    })["catch"]((function(e) {
                        _this5.setError(e);
                        _this5.loginForm.setLoading(false);
                ...
                value: function(thirdNickName, data, mode) {
                    ...
                    Promise.all(promises)["catch"]((function(e) {
                        ...
                        _this6.loginForm.setLoading(false);
                    }))["finally"]((function() {
