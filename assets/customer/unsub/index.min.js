    ...
    (() => {
        ...
        var Unsub = function() {
            ...
            unsub_createClass(Unsub, [ {
                ...
                value: function() {
                    var _this = this;
                    var $textareaSelector = $(this.textareaSelector);
                    $textareaSelector.on("input", (function(event) {
                        ...
                        if (event.target.value.length > 300) {
                            $(_this.textareaWrapSelector).addClass("has-error");
                            _this.validate = false;
                        } else {
                            $(_this.textareaWrapSelector).removeClass("has-error");
                            _this.validate = true;
                        }
                ...
                value: function() {
                    var _this2 = this;
                    $(this.reasonRadioSelector).on("change", (function(event) {
                        _this2.reason = event.target.value;
                        $(_this2.submitSelector).removeAttr("disabled");
                        if ("6" === _this2.reason) $(_this2.textareaWrapSelector).show(); else $(_this2.textareaWrapSelector).hide();
                    }));
                    $(this.submitSelector).on("click", (function() {
                        if (!_this2.reason) return false;
                        if ("6" === _this2.reason && !_this2.validate) return false;
                        $(_this2.submitSelector).attr("disabled", "disabled").addClass("btn--loading");
                        postUnSubscribe({
                            ...
                            $(_this2.submitSelector).removeClass("btn--loading");
                            setTimeout((function() {
                                window.location.href = HOME;
                            }), 3e3);
                        }))["catch"]((function() {
                            $(_this2.submitSelector).removeAttr("disabled").removeClass("btn--loading");
                        }));
                    }));
                }
            } ]);
