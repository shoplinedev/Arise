...
(self["webpackChunkArise"] = self["webpackChunkArise"] || []).push([ [ "testimonials" ], {
    ...
    "./src/assets/stage/testimonials/index.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
        ...
        var swiper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./node_modules/swiper/esm/components/navigation/navigation.js");
        var swiper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./node_modules/swiper/esm/components/pagination/pagination.js");
        ...
        var _commons_utils_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/assets/commons/utils/helper.js");
        ...
        var Testimonials = function() {
            ...
            _createClass(Testimonials, [ {
                ...
                value: function() {
                    ...
                    var el = $el[0];
                    var slidesPerGroup = this.getSlidesPerGroup();
                    var swiperOptions = {
                        slidesPerGroup,
                        ...
                        pagination: {
                            ...
                            renderCustom: function(swiper, current, total) {
                                return '\n            <a href="javascript:void(0);" class="testimonials__arrow--left'.concat(1 === current ? " testimonials__arrow--disabled" : "", '">').concat(navigation_arrow_icon, '</a>\n            <span class="testimonials__arrow--text body4">').concat(current, "/").concat(total, '</span>\n            <a href="javascript:void(0);" class="testimonials__arrow--right').concat(current === total ? " testimonials__arrow--disabled" : "", '">').concat(navigation_arrow_icon, "</a>\n          ");
                            }
                        }
                    };
                    this.swiper = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"](el, swiperOptions);
                ...
                value: function() {
                    return "mobile" === _commons_utils_helper__WEBPACK_IMPORTED_MODULE_5__["default"].getPlatform() ? 1 : 3;
                }
            }, {
                key: "destroy",
                value: function() {
        ...
        (0, _yy_sl_theme_shared_utils_sectionsLoad__WEBPACK_IMPORTED_MODULE_4__.registrySectionConstructor)(TestimonialsSection.type, TestimonialsSection);
    }
}, __webpack_require__ => {
