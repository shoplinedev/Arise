...
(self["webpackChunkArise"] = self["webpackChunkArise"] || []).push([ [ "text-columns-with-images" ], {
    ...
    "./src/assets/stage/text-columns-with-images/index.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
        ...
        var swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./node_modules/swiper/esm/components/core/core-class.js");
        var swiper__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./node_modules/swiper/esm/components/navigation/navigation.js");
        var swiper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./node_modules/swiper/esm/components/pagination/pagination.js");
        ...
        var _commons_utils_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/assets/commons/utils/helper.js");
        ...
        swiper__WEBPACK_IMPORTED_MODULE_5__["default"].use([ swiper__WEBPACK_IMPORTED_MODULE_6__["default"], swiper__WEBPACK_IMPORTED_MODULE_7__["default"] ]);
        var selectors = {
            slide: ".swiper-slide",
        ...
        var Slider = function() {
            ...
            _createClass(Slider, [ {
                ...
                value: function() {
                    ...
                    var $el = container.find(selectors.slideContainer);
                    var el = $el[0];
                    var spaceBetween = $el && $el.data("no-spacing") ? 20 : 10;
                    var slidesPerView = $el && $el.data("no-spacing") ? 1.2 : 1.15;
                    var swiperOptions = {
                        threshold: 5,
                        init: true,
                        observer: true,
                        ...
                        pagination: {
                            ...
                            renderCustom: function(swiper, current, total) {
                                return '\n            <a class="text-columns-arrow--left'.concat(1 === current ? " text-columns-arrow--disabled" : "", '">').concat(navigation_arrow_icon, '</a>\n            <span class="text-columns-arrow--text body4">').concat(current, "/").concat(total, '</span>\n            <a class="text-columns-arrow--right').concat(current === total ? " text-columns-arrow--disabled" : "", '">').concat(navigation_arrow_icon, "</a>\n          ");
                            }
                        }
                    };
                    this.swiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](el, swiperOptions);
                    this.swiper.on("resize", (function(swiper) {
                        var currentSlidesPerGroup = _this.getSlidesPerGroup();
                        swiper.updateSize();
                        swiper.updateSlides();
                    ...
                    $el.on("click", selectors.navigationPrev, (function() {
                        _this.swiper.slidePrev();
                    }));
                    $el.on("click", selectors.navigationNext, (function() {
                        _this.swiper.slideNext();
                    }));
                }
            }, {
                key: "getSlidesPerGroup",
                value: function() {
                    return "mobile" === _commons_utils_helper__WEBPACK_IMPORTED_MODULE_4__["default"].getPlatform() ? 1 : 3;
                }
            }, {
                key: "destroy",
                value: function() {
        ...
        var TextColumnsWithImages = function() {
            function TextColumnsWithImages(container) {
                _classCallCheck(this, TextColumnsWithImages);
                _defineProperty(this, "instance", null);
                if (!container.find(selectors.slide).length) return;
                this.instance = new Slider(container);
            }
            _createClass(TextColumnsWithImages, [ {
                key: "onUnload",
                value: function() {
                    if (this.instance) this.instance.destroy();
                }
            } ]);
            return TextColumnsWithImages;
        }();
        _defineProperty(TextColumnsWithImages, "type", "text-columns-with-images");
        (0, _yy_sl_theme_shared_utils_sectionsLoad__WEBPACK_IMPORTED_MODULE_3__.registrySectionConstructor)(TextColumnsWithImages.type, TextColumnsWithImages);
    }
}, __webpack_require__ => {
