(self["webpackChunkArise"] = self["webpackChunkArise"] || []).push([ [ "activity" ], {
    ...
    "./src/assets/activity/main.js": (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
        ...
        const init = () => {
            const cartNode = __SL_$__("#activity-cart");
        ...
        function handleTagsShow() {
            const $tags = __SL_$__(".sales__promotion-tags-tag-hook");
            if (!$tags[0]) return;
        ...
        const promotion_tags = (0, effectFc["default"])((function(parent) {
            ...
            const container = __SL_$__(parent || document.body);
        ...
        const productTabs_CartInfoKey = "cartInfo";
        const TooltipSelector = ".activity__productTabs .tab2";
        const productTabs = () => {
            const activity = state_selector.SL_State.get("activity");
            const request = state_selector.SL_State.get("request");
            if (12 === (null === activity || void 0 === activity ? void 0 : activity.benefitType) && 0 === activity.promotionSubType) {
                ...
                const updateCartInfo = cartInfo => {
                    ...
                    const promotion = null === (_cartInfo$activeItems = cartInfo.activeItems) || void 0 === _cartInfo$activeItems ? void 0 : null === (_cartInfo$activeItems2 = _cartInfo$activeItems.find) || void 0 === _cartInfo$activeItems2 ? void 0 : null === (_cartInfo$activeItems3 = _cartInfo$activeItems2.call(_cartInfo$activeItems, (item => {
                        var _item$promotion;
                ...
                __SL_$__(document.body).on("click", ".activity__productTabs-tooltip i", (() => {
                    resetTooltip(false);
                }));
                const cartInfo = state_selector.SL_State.get(productTabs_CartInfoKey);
        ...
        const initSortSelector = () => {
            __SL_$__(".sales__activity-sort-selector-hook").on("change", (function() {
                ...
                const sortBy = __SL_$__(this).val();
        ...
        function promotionTimeInit() {
            var _SL_$__;
            const node = null === (_SL_$__ = __SL_$__(".activity__limit-time-text")) || void 0 === _SL_$__ ? void 0 : _SL_$__[0];
            if (!node) return;
            const activity = state_selector.SL_State.get("activity");
        ...
        function countdownInit() {
            ...
            const activity = state_selector.SL_State.get("activity");
            const {salesEnvCustomInfo, endTime, discountCodeList} = null !== activity && void 0 !== activity ? activity : {};
            const {countDownUnit, showCountDown, bannerActivated} = null !== (_salesEnvCustomInfo$l = null === salesEnvCustomInfo || void 0 === salesEnvCustomInfo ? void 0 : salesEnvCustomInfo.landingPageConfig) && void 0 !== _salesEnvCustomInfo$l ? _salesEnvCustomInfo$l : {};
            const countDownCon = __SL_$__(".countdown-cells");
            ...
            const copyEle = __SL_$__(".coupon_copy");
            const toast = new components_toast["default"];
            copyEle.on("click", (() => {
            ...
            countdown["default"])(endTime, (([d, h, m, s], interval) => {
        ...
        __SL_$__(document).ready((() => {
            ...
            sort_selector();
            window.SL_EventBus.on("global:currency:format", (() => {
                const amountNode = __SL_$__("[data-amount]");
                amountNode.each((function() {
                    const amount = __SL_$__(this).data("amount");
