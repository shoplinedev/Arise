(self["webpackChunkArise"] = self["webpackChunkArise"] || []).push([ [ "activity" ], {
    ...
    "../shared/browser/components/hbs/cartSalesPromotion/js/content/reminder/getPromotionReminder.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var getShoppingReminderTranslate = function(promotion, configs, options) {
            var config = (0, _sales_shoppingPromotionReminder__WEBPACK_IMPORTED_MODULE_2__["default"])(_yy_sl_theme_shared_utils_newCurrency_CurrencyConvert__WEBPACK_IMPORTED_MODULE_1__.convertFormat)(promotion, configs, options);
    ...
    "../shared/browser/components/hbs/sales/shoppingPromotionReminder/index.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function shoppingPromotionReminder(currency) {
            ...
            function formatBenefitNum(str, type, options) {
                ...
                if ((0, _utils_syntax_patch__WEBPACK_IMPORTED_MODULE_11__.get)(type, "benefitType") === BenefitTypeEnum.NTH_FIXED_PRICE || (0, 
                _utils_syntax_patch__WEBPACK_IMPORTED_MODULE_11__.get)(type, "benefitType") === BenefitTypeEnum.PRICE || (0, 
                ...
                if (promotionBenefitList.length) {
                    ...
                    return {
                        ...
                        params: {
                            ...
                            currentMinThreshold: setWrapper((0, _utils_syntax_patch__WEBPACK_IMPORTED_MODULE_11__.get)(current, "minThreshold"), _objectSpread(_objectSpread({}, warper), {}, {
                            ...
                            nextMinThreshold: setWrapper((0, _utils_syntax_patch__WEBPACK_IMPORTED_MODULE_11__.get)(next, "minThreshold"), _objectSpread(_objectSpread({}, warper), {}, {
                                class: "sales__promotionReminder-threshold custom-sale-color ".concat(nc((0, _utils_syntax_patch__WEBPACK_IMPORTED_MODULE_11__.get)(warper, "class"), ""))
                            })),
